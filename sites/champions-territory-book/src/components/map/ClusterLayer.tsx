 ...
 * `MapCanvas` owns the container, the rings, the branch mark and the fit
 ...
 * group that the group does not support: seven marks reading "hvac"
 ...
 * halo and the words, exactly as it owns the prospect mark and the branch,
 ...
 *
 * This is the change that makes three hundred and twenty nine organisations feel
 ...
 * every single render of this layer replaced three hundred and twenty nine
  ...
  */
    ...
    return (
      <Marker
        ...
        /*
          ...
          as a tooltip: the organisation, its service line and its occasion class,
        ...
        */
        title={`${p.name}. ${meta.label}, ${
          meta.occasionClass === "calendar-locked"
            ? "calendar locked"
            : "discretionary"
        }. ${row.miles.toFixed(1)} straight line miles from the Brea branch.`}
        keyboard
        eventHandlers={{
  ...
  return (
    /*
      ...
      z-index 590, so that the branch mark and the ring labels in the default
      ...
      broken ring reading "Our address" was buried under a cluster bubble
      ...
      application already relies on: the branch is forced to 1000 and the
      ring labels to 500, both far beyond the pixel heights a mark can
      reach, so our own address is always on top of the organisations around
