 ...
 * ---------------------------------------------------------------
 *
 * The build before last carried, on every one of three hundred and twenty nine
 ...
 * was three hundred and twenty nine identical white pills, each one repeating the
 ...
 * gap costs six pixels three hundred and twenty nine times.
 *
 * ---------------------------------------------------------------
 ...
 *
 * THE SERVICE LINE MARK, because it is the shape of the sales call. A
 * failed condenser in August and a property manager choosing a vendor
 * list are two different conversations, and the mark says which before
 * the name is read.
 *
 ...
 *
 * The candidates were the score, the door count range and the distance,
 * and each of them decides something. Distance decides the route. Doors
 ...
 * a time, three hundred and twenty nine times. Two channels replaced the word.
 *
 ...
 * tidy thirds. The three hundred and twenty nine organisations run from twenty one
...
export function ProspectListCard({
  ...
  return (
    <li
      ...
      /*
        RHYTHM, AND IT COSTS NOTHING IN HEIGHT. Three hundred and twenty nine
