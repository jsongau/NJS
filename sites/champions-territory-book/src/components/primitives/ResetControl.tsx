 ...
 * seeded pipeline has three hundred and twenty nine organisations, two contracts
...
export function useEditLedger(): EditLedger {
  ...
  /*
    ...
    survivable while nothing survived a reload: a corrected job value
    typed onto a seeded line was gone at the next refresh whether the
    badge mentioned it or not. It is not survivable now. That edit is
    kept, it is the single most likely thing a reader changes on the Book
    page, and a confirmation that offers to throw away "nothing" and then
    throws away a corrected number of doors has lied to somebody at the
