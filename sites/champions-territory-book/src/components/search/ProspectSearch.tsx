 ...
 * Two letters went in, the board dropped from three hundred and twenty nine rows
...
function bestHit(p: Prospect, term: string): FieldHit | null {
  ...
  /* The service line is offered under both its names. A reader who
     types "drain" means the line whose short form is "Drain and sewer",
     and a reader who types "air" means the one whose full label says
     "Heating and air conditioning". Either should land. */
