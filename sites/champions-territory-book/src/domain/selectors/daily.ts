 ...
 * contracts signed would read zero on almost every day of a slow autumn
...
/** Day of the week for a branch-local calendar date, 0 for Sunday. */
...
export interface DailyReading {
  /** The branch-local day these figures describe. */
  day: string;
  weekday: string;
  working: boolean;
  rings: RingReading[];
 ...
 *
 * One pass over the three hundred and twenty nine records, because the three
