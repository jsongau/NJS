 ...
 * way. Standing on a screen and pressing Rationale gets you how that
 * screen was built. Pressing Console again puts you back on it.
 *
 ...
 * it counts crew days rather than leads had to go somewhere else and
 * then search. An explanation that is not attached to the thing it
 * explains is a document, and there was already a document.
 *
 ...
 * explanation of a screen is drawn in that screen's identity rather than
 * in one colour for all twenty seven. Rationale is a second reading of
 * the same places, not a place of its own, and a single hue across the
 * mode would have said the opposite.
 *
      ...
      <div className={styles.wrap}>
        ...
        <footer className={styles.foot}>
          <p className={styles.last}>
            ...
            a Champions Group product, it does not represent Champions Group
            Holdings or any of its brands, and it was built by one person for
            a job application. Every figure on the screen this explains
            carries where it came from, and{" "}
