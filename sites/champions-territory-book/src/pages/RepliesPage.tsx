 ...
 * hiring manager who has actually run a branch knows that, which is
 ...
 *
 * Fairway Ford is here saying no in its own words: facilities is
 * contracted through the dealer group and has been for three years, and
 * come back in February about the fleet vehicle work. That sentence is
 * worth more than any of the yeses above it, because it does two things
 * a bare "no" cannot. It tells you the facilities door is shut and
 * roughly for how long, and it tells you a second door was left open by
 * the buyer themselves, with a month on it. A shut drain contract and an
 * open fleet conversation is a different answer from no, and the
 * follow-up it earns is a diary entry rather than another email about
 * the drains.
 *
 ...
 * has happened at all, which is a perfectly reasonable state for a
 * territory nobody has worked yet.
 */
...
<span className={styles.ident}>
      ...
      {/*
        ...
        turns on the difference between what the brand said and what the
        organisation said back, and the one sentence on this card that
        did not come from the brand is the one worth reading twice.
      */}
