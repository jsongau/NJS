 ...
 * found ninety of three hundred and twenty nine organisations missing from the
...
export function furthestStatus(
  ...
  /* "lost" is deliberately last in RANK and deliberately NOT treated as
     furthest-along here. An organisation that said no on a drain contract
     and is mid-conversation about the heating turnover is a live
