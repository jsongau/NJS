 ...
 * fiction about a venue that has not opened, and the credibility of
 * every other figure rests on there being none of those.
 *
 ...
 * signed contracts and the SAME three hundred and twenty nine rows. Nothing is
...
export const SCENARIOS: Scenario[] = [
  {
    ...
    asOf: BOARD_DAY,
    label: "Today",
    because: "The board as it stands. Two agreements signed, neither started, and the published campaign three weeks behind its own expiry",
  },
  {
    id: "window-open",
    asOf: "2026-10-05",
    ...
    because:
      "The first rebooking window on the board opens, a fortnight before the first agreement is due to start",
  },
  {
    id: "window-closing",
    asOf: "2026-11-14",
    label: "First window closes",
    because: "That rebooking window reaches its last day, and an unanswered window is a renewal lost rather than a task overdue",
  },
  {
    id: "first-delivered",
    asOf: "2026-11-21",
    ...
    because:
      "The first agreement has started, so the check-in and the review ask both fall due",
  },
  {
    id: "both-delivered",
    asOf: "2026-12-27",
    label: "After both",
    because: "Both agreements have started and both accounts are on the renewal clock",
  },
  {
    id: "next-year",
    asOf: "2027-06-01",
