...
<html><head><meta charset="utf-8"><style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  <div>
    ...
    <div class="rule"></div>
    <h1>DIME</h1>
    <div class="sub">A sales performance analytics prototype.</div>
  </div>
  <div class="figs">
    <div><div class="n">${organisations}</div><div class="l">Accounts on the board</div></div>
    <div><div class="n">${cities}</div><div class="l">Markets</div></div>
    <div><div class="n">6</div><div class="l">Provenance classes</div></div>
  </div>
  <div class="foot">
    <div>
      <div class="who">Nathan J. Song</div>
      <div class="url">nathanjsong.com/dime</div>
    </div>
    <div class="disc">Not affiliated with, endorsed by, or a<br>product of DIME Industries, LLC.</div>
  </div>
</body></html>`;
 ...
 * json beside it. The result was a sidecar claiming DIME and 109 sitting
...
fs.writeFileSync(
  ...
  JSON.stringify({ organisations, cities, name: "DIME", url: "nathanjsong.com/dime", sha256 }, null, 2) + "\n",
);
