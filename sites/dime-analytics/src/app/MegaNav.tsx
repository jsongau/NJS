 ...
 * territory around Irvine, contacts organisations, records what each said,
...
export function MegaNav({
  ...
  const markLabel =
    `DIME. The dial and the pin both show how far the trade ` +
    ...
    <div className={styles.bar}>
      ...
      */}
      <div className={styles.brand}>
        ...
        >
          <span className={styles.brandText}>DIME</span>
        </Link>
      </div>
