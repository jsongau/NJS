    ...
    items: [
      {
        ...
        label: "Packages",
        sec: "packages",
        hint: "Every package DIME publishes, and every price it does not",
      },
      {
        to: "/coaching",
        label: "Coaching",
...
export function SideRail() {
  ...
  */
   ...
   * DIME publishes no group price, no capacity plan and no budget, so a
  ...
  const markLabel =
    `DIME. The dial round the ball shows how far the trade ` +
  ...
  /* THE COUNTDOWN THAT USED TO STAND HERE HAS GONE. It counted weeks
     ...
     not a fact about DIME. DIME Industries has traded in the US
     since 2010 and the Irvine office is open for business, so there is
  ...
  return (
    <nav
      ...
      aria-label="Every screen in DIME"
    >
        ...
        <div className={styles.brand}>
          ...
          */}
          <Link
            ...
            aria-label="DIME, go to the desk"
          >
