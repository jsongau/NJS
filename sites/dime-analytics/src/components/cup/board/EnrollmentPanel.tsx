 ...
 * DIME publishes no league or cup programme at any location, so the cup
 ...
 *
 * WHAT THE FIELD IS NO LONGER TIED TO IS A PUBLISHED LANE COUNT. DIME
 ...
 * DIME publishes nothing at all about leagues, a fee included, and
          ...
          <div className={styles.slots}>
            ...
            <p className={styles.slotsWhy}>
              ...
              <span>
                ...
                <WithheldFigure
                  reason="DIME publishes no lane count for any location, including Lakewood Center, the nearest store to this office. The field above is this board's own figure and the scarcity in it is arithmetic, not a claim about the building."
                />
              </span>
            </p>
          </div>
