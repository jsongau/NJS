 ...
 * application's own proposal and never as a DIME price. DIME
    ...
    >
      ...
      <CupBlock title="Team average">
        <EstablishedFigure
          ...
          rule={`Handicap will be ${cup.handicapFactorPct} per cent of ${cup.handicapBasis} once there are averages to compute one from. That basis is this proposal's own and DIME publishes no handicap system.`}
        />
      </CupBlock>
    </CupDialog>
  );
