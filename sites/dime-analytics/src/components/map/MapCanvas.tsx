 ...
 * the Irvine office is DIME Industries' US corporate head office.
 ...
 * south of the Irvine office, so a label placed there sat over the fewest
 * pins. That is a true
...
function FitToFilter({
  ...
  useEffect(() => {
    ...
    /*
      ...
      of one lane that has scrolled the Irvine office off the edge
    ...
    >
      ...
      */}
      <p className="visually-hidden" role="status" aria-live="polite">
        {rows.length} organisations plotted around DIME's Irvine head
        ...
        straight line miles from the Irvine office, and they are not
        drive times.
        ...
        */}
        ...
        {ringLabel ? (
          <Marker
            ...
            */
            title={`${ringLabel.ring.miles} straight line miles from the Irvine office, not a drive time. ${ringLabel.ring.note}`}
            interactive={false}
            keyboard={false}
        ...
        {/*
          ...
          latitude, and there are organisations north of the Irvine office
          ...
          >
            <div className={styles.popup}>
              ...
              <p className={styles.popupNotOpen}>
                <span aria-hidden="true">◌</span> Not a store. This is DIME Industries' US corporate head office, and no page on
                dimeindustries.com claims there is bowling, an arcade or a party
                room at this address. The number is DIME's published
