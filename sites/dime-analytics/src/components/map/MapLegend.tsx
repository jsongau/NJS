        ...
        <ul className={styles.entries}>
          <li className={`${styles.entry} ${styles.entryStacked}`}>
            ...
            <span className={styles.entryText}>
              ...
              a solid pin would say a group could walk in here. This is DIME Industries' US corporate head office, and no page on
              dimeindustries.com puts bowling, an arcade or a party room at this
              address.
            </span>
          </li>
          ...
          <li className={styles.entry}>
            ...
            <span className={styles.entryText}>
              ...
              and five miles as the crow flies from the Irvine office. These are not
