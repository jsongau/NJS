 ...
 *
 * WHY THIS CARD EXISTS AND WHY IT IS NOT A DISCOUNT PANEL. DIME
 ...
 * that.
 *
 * So the currency here is CERTAINTY rather than money. What DIME states
 ...
 * halves of the sentence on dimeindustries.com in fifteen seconds. That
 ...
 * until a venue opened. Both are gone. DIME publishes no deadline, and
 * the Irvine office is open for business, so a clock here would be
    ...
    >
      ...
      <div id={bodyId} className={styles.body} hidden={!open}>
          ...
          <div className={styles.figureCell}>
            ...
            <dd>
              {/*
                ...
                DIME publishes is what an offer contains, never which kinds
        ...
        <p className={styles.compliance}>
          Every offer here quotes something DIME states on its own pages and
