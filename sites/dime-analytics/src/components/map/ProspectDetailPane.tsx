 ...
 * It does not invent a discount: DIME publishes no price for any party
      ...
      >
        ...
        <div className={styles.scroller} ref={scrollRef}>
            ...
            <dl className={styles.facts}>
              ...
              <Fact label="Bowling lanes">
                ...
                {/*
                  ...
                  building. DIME publishes no lane count for any
                ...
                */}
                <span className={styles.hint}>
                  ...
                  <WithheldFigure reason="DIME publishes no lane count for any location, so there is no total to take a share of. The nearest store, Lakewood Center, publishes an amenity list and no lane count either." />
                </span>
              </Fact>
                ...
                {record.bookLines.length > 0 ? (
                  ...
                  <>
                    <Figure
                      ...
                      withheldReason={`DIME publishes no price for ${leadPackage ? leadPackage.name : "the lead package"}, or for any other party package. Its booking page says to contact the venue, which is the reason this role exists.`}
                      compact
                    />
                    {leadValue === null ? null : (
                      <span className={styles.hint}>
          ...
          {/* -------------------------------------------------------
              ...
              the venue. Never a discount: DIME publishes no party
