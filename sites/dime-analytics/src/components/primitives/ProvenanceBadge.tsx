 ...
 *
 * DIME publishes what a walk-in buys off a shelf and almost nothing a
 ...
 * defaults to DIME and any caller can pass its own. A withheld
...
const META: Record<Provenance, ProvenanceMeta> = {
  ...
  withheld: {
    ...
    glyph: "▩",
    title:
      "DIME deliberately does not publish this figure. Their page says to contact the venue, which is why this app exists.",
    cls: "withheld",
  },
};
 ...
 * app failed to fetch. What is true is stronger and shorter: DIME
    ...
    >
      ...
      <span className={styles.withheldBody}>
        <strong className={styles.withheldLead}>
          {lead ?? "DIME does not publish this"}
        </strong>
        {compact ? null : (
