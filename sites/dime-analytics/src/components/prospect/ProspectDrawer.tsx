 ...
 *
 * No price for a gated package, and no lane count. Where DIME publishes
          ...
          <section className={styles.section} aria-labelledby="sec-size">
            ...
            <div className={styles.lanesBox}>
              ...
              {/*
                ...
                DIME publishes no lane count for any location, so there
              ...
              */}
              <p className={styles.lanesNote}>
                <WithheldFigure reason="DIME publishes no lane count for any location, and none for Lakewood Center, the nearest store to this office. So this figure is a size, not a share, and there is no percentage of the building to quote off it." />
              </p>
              <p className={styles.lanesNote}>
                ...
                published DIME rule, which is why the block is badged
