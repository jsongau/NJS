        ...
        {r.headcount !== null ? (
          <>
            ...
            {/*
              ...
              DIME publishes no lane count anywhere, so there is no
            ...
            */}
            <p className={styles.laneWarn}>
              <span aria-hidden="true">◉</span>
              <WithheldFigure reason="DIME publishes no lane count for any location, so whether this headcount fits in one sitting cannot be answered off a page. Lakewood Center is the nearest store and its page carries an amenity list, no lane count and no phone number, so this question goes to the store in person." />
            </p>
          </>
        ) : (
          <p className={styles.walkIn}>
