 ...
 * number. A desk that has been working the Irvine trade area for a few
 ...
 *
 * NO LANES ARE HELD BY EITHER LINE. DIME publishes no bowling lane
...
export const SEED_BOOK: BookLine[] = [
  {
    ...
    /*
      ...
      it renders. DIME publishes the contents of the All Inclusive
    ...
    */
    ...
    /*
      DIME publishes no lane count and no guests per lane figure, so
 ...
 * and that is honest rather than careless: the Irvine board carries no
...
export const SEED_ACTIVITY: ActivityLine[] = [
  ...
  },
  {
    ...
    locationLabel: "Los Irvine Center concourse, Saturday trading hours",
    week: "2026-09-14",
    hours: 4,
  ...
  },
  {
    ...
    locationLabel: "Irvine College, club rush week tables",
    week: "2026-09-28",
    hours: 5,
  ...
  },
  {
    ...
    ledger: "outbound-activity",
    type: "go-see",
    locationLabel: "Card, hobby and collectible counters, Irvine and Artesia",
    week: "2026-10-05",
    hours: 3,
  ...
  },
  {
    ...
    notes:
      "The Irvine trade area does not stop at the city line and neither do its neighbouring chambers. Santa Fe Springs is where the suppliers are and Los Alamitos is where a second set of employers is. Same evening format, a different few hundred businesses.",
    sortOrder: 8,
  },
  {
    id: "act-seed-10",
    ledger: "outbound-activity",
    type: "venue-tour",
    locationLabel: "DIME Lakewood Center, 401 Lakewood Ctr Mall",
    week: "2026-10-12",
    hours: 3,
    targetConversations: 6,
    seatId: "seat-1",
    ...
    notes:
      "The nearest store to the office and the only DIME floor inside this trade area. It is open, it trades until midnight on a weeknight, and a buyer who has stood on the floor asks a different set of questions afterwards. Nothing here is a claim about the store's capacity, because no lane count is published for it.",
    sortOrder: 9,
  },
];
 ...
 * first. Lexus of Irvine is here saying no in their own words, and the
