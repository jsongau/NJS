 ...
 * ---------------------------------------------------------------
 *
 * There is no quarterly cup on dimeindustries.com, no cup calendar, and no
 ...
 * not a claim about how DIME operates.
 *
 * ---------------------------------------------------------------
 ...
 * everywhere it renders. DIME publishes no league price and no cup
...
const FEE_NOTE =
  "This application's own, invented for the prototype, and not a claim about how DIME operates. DIME publishes no dollar amount for a league or a cup anywhere, and neither does Lucky Strike Entertainment.";
