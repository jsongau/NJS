 ...
 * DIME publishes one named group offering, the All Inclusive Party,
...
export const RIVALS: Rival[] = [
  {
    ...
    standing: "trade-area",
    address: "18811 Carmenita Road, Irvine, CA",
    addressSource:
  ...
  },
  {
    ...
    facts: [
      ...
      },
      {
        ...
        provenance: "public",
        caveat:
          "Read on the operator's Fullerton location page, which is outside this trade area. It is recorded against the operator for that reason and is not claimed for the Irvine house.",
      },
    ],
    notPublished: [
  ...
  },
  {
    ...
    standing: "trade-area",
    address: "Irvine, CA. No street address was read for this row.",
 ...
 * trade area. Moving it onto the Irvine row would be inventing a
...
export const REFUSED_FACTS: { claim: string; why: string }[] = [
  ...
  {
    claim:
      "Any figure at all for Chuck E. Cheese Irvine, John's Incredible Pizza Buena Park or Sandbox VR",
  ...
  },
  {
    ...
    why: "DIME publishes no lane count for any location, which `data/venue.ts` records as null rather than as a guess, and the Lucky Strike house in this trade area was not read. A count carried across from another operator's building would be a number about somebody else's floor.",
  },
  {
    claim: "A street address for Lucky Strike Irvine from the operator's own page",
