 ...
 * ---------------------------------------------------------------
 *
 * DIME publishes no league price and no cup price, and the withheld
 ...
 * it is never presented as a DIME price. It is also not added to
...
export interface Cup {
   ...
   *
   * ILLUSTRATIVE, ALWAYS, AND NEVER A ROUND1 PRICE. DIME publishes no
