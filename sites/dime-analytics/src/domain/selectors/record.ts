 ...
 *
 * THESE ARE THIS DESK'S OWN INTERVALS AND THEY ARE ILLUSTRATIVE. DIME
 * publishes no service level of any kind, so nothing here is a claim
 * about how DIME operates.
 */
...
> = {
  ...
  "asked-for-a-price": {
    ...
    weight: 25,
    note: "The most common opening question in this territory and the hardest to answer, because no group price is published at all.",
  },
  "named-a-headcount": {
 ...
 * result, which is exactly what a one person board must not be used
 * for.
 */
