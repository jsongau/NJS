 ...
 * DIME publishes the contents of one party package in this file and
...
const RAMP: RampStep[] = [
  {
    ...
    what: (
      <>
        Sort the range into the packages DIME publishes a price for and
        ...
        dimeindustries.com. A priced package is one a parent buys alone at night on
  ...
  },
  {
    ...
    /*
      ...
      different operator's figure for a different building, and DIME
    ...
    */
    what: (
      <>
        ...
        <WithheldFigure reason="DIME publishes no bowling lane count for any location, including Lakewood Center, the nearest store to this office. A rep can size a group off the ratio and cannot check it against the house, so the lane count is the first thing to get from the store and write down." />
      </>
    ),
...
const CALL_FRAME: Record<OccasionClass, CallFrame> = {
  ...
  discretionary: {
    ...
    leadWith:
      "The corporate family, where DIME publishes no price at all. So the first conversation is about fit and date, and the number arrives later, from a person, which is the entire reason the role exists.",
  },
};
    ...
    <div className={styles.page}>
      <div className={styles.inner}>
              ...
              <ul className={styles.metrics}>
                ...
                <li className={styles.metric}>
                  ...
                  <p className={styles.metricNote}>
                    ...
                    price a person typed rather than a price DIME
        ...
        <p className={styles.foot}>
          ...
          rule were read off dimeindustries.com. A lane count was not, because
          DIME publishes none for any location, so no figure on this page is
