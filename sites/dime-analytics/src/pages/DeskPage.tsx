      ...
      {expanded ? (
        <div className={styles.breakdown} id={whyId}>
          ...
          <p className={styles.breakdownFoot}>
            ...
            ratio of one lane per twenty guests. DIME publishes no lane
        ...
        */}
        ...
        <section className={styles.kpis} aria-labelledby="desk-strip-heading">
          ...
          <Kpi
            ...
            note="Real, inside roughly seven miles of the Irvine office. Every one was read off a published page and geocoded with the US Census Bureau geocoder on 17 August 2026. No Places call was made, so no row carries a place id."
            provenance="public"
          />
          <Kpi
