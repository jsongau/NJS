        ...
        <article className={styles.sheet}>
          <div className={`${styles.masthead} avoid-break`}>
            ...
            <p className={styles.mastheadNote}>
              ...
              <span>
                ...
                because DIME publishes no trading calendar of any kind.
                Nothing on this page is a claim about how DIME runs a
                territory.
              </span>
            </p>
          </div>
              ...
              <div className={`${styles.ledger} avoid-break`}>
                ...
                <dl className={styles.ledgerFigures}>
                  ...
                  <Figure
                    ...
                    note="DIME publishes no price for any group package, so this share of the total came off this desk rather than off a rate card."
                  />
                </dl>
              </div>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.sectionNote}>
              ...
              regardless. DIME publishes no minimum booking notice, so the
                  ...
                  >
                    ...
                    <dl className={styles.rowFacts}>
                      ...
                      {/*
                        ...
                        not: DIME publishes no bowling lane count for
                        ...
                        another city beside a DIME hold, which is
        ...
        <div className={`${styles.method} no-print`}>
          ...
          <ul className={styles.methodList}>
            ...
            <li>
              ...
              because DIME publishes no bowling lane count for any location,
