 ...
 * what DIME actually sells into them, and the single hardest thing
      ...
      */}
      ...
      <div className={styles.packages}>
        ...
        <p
          ...
          title="DIME's page for each gated package says to contact the venue."
        >
          {gated === 0 ? (
      ...
      <div className={styles.inner}>
        ...
        {[locked, chosen].map((group) => {
          ...
          /* The top of the summed range, in bowling lanes, at this app's own
             ...
             because DIME publishes no lane count for any location. */
        ...
        <p
          ...
          title="Every package name, guest minimum, day part and price on this page was read off dimeindustries.com on 17 August 2026 and carries the URL it came from on the packages screen."
        >
          Packages read off dimeindustries.com, 17 August 2026. A missing price is
          missing because DIME does not publish one.
        </p>
      </div>
    </div>
  );
