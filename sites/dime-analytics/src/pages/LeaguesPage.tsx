 ...
 * DIME publishes no league of any kind, at any location. A competitor
 ...
 * DIME publishes no league price anywhere and neither does any
      ...
      <div className={styles.inner}>
        ...
        <section className={styles.section} aria-labelledby="lg-published">
          ...
          <p className={styles.sectionFoot}>
            ...
            stops at the lanes a group needs, because DIME publishes no house
    ...
    <article className={styles.card}>
      ...
      <dl className={styles.cardFacts}>
        ...
        {/*
          ...
          is null for every league, because DIME publishes no bowling
        ...
        */}
        <div className={styles.cardFact}>
          ...
          <dd>
            ...
            <span className={styles.factSub}>
              DIME publishes no lane count, so there is no share to give
            </span>
          </dd>
        </div>
        <div className={styles.cardFact}>
