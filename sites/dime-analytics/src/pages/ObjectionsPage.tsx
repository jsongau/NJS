 ...
 * DIME's own deliberate design rather than an accident of the website,
 * and the honest answer to it is the entire argument for filling this
 * role. DIME names one group package, itemises it in full, and
          ...
          <section className={styles.feature} aria-labelledby="feature-h">
            <div className={styles.featureHead}>
              ...
              <h2 className={styles.h2} id="feature-h">
                The objection DIME created on purpose
              </h2>
            ...
            {cardFor(
              ...
              <div className={styles.gate}>
                    ...
                    <WithheldFigure
                      reason={
                        <>
                          ...
                          comes from a person. Nothing on dimeindustries.com
                ...
                <p className={styles.gateFoot}>
                  <Link to="/packages">
                    Every package, and what DIME publishes for it
                  </Link>
                  .
                </p>
              </div>,
