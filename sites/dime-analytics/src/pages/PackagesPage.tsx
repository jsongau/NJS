 ...
 * DIME names one group product in public, the All Inclusive Party, and
 ...
 * a reader can check every claim against dimeindustries.com in about fifteen
 * seconds a row.
 *
 * ── WHY THIS IS NOT A PRICE LIST ───────────────────────────────────
 * There is no price to list. What somebody selling this actually needs
 * off this screen is everything DIME publishes about a package it will
 ...
 *
 * The day-part block stays on the card even though DIME fences
 ...
 * It never fills a null. A figure DIME withholds renders as the
 ...
 *
 * WithheldFigure prints "DIME does not publish this" on its own,
...
/**
 * The phrases to search package inclusions for, per figure DIME does
 * not publish.
 *
 ...
 * DIME does not publish anywhere.
 *
...
function PackageCard({
  ...
  /*
    ...
    figure for another building. DIME publishes no lane count for any
  ...
  return (
    ...
    >
      <header className={styles.cardHead}>
        ...
        <div className={styles.cardHeadText}>
          ...
          <div className={styles.cardChips}>
            ...
            {fenced ? (
              <span className={styles.leverTag} title="DIME has published a day-part fence on this package that keeps it out of peak hours.">
                ...
                <span className={styles.derived}>
                  ...
                  {shareOfFloor === null ? (
                    <>
                      ...
                      DIME publishes no bowling lane count for any location.
      ...
      <a
        ...
        aria-label={`Read the ${pkg.name} page on dimeindustries.com, opens in a new tab`}
      >
...
export function PackagesPage() {
  ...
  */
  ...
  /* Every attraction DIME publishes, all of them chain-wide claims
    ...
    <div className={styles.page}>
      <div className={styles.inner}>
        <header className={styles.head}>
          <p className={styles.eyebrow}>What DIME publishes</p>
          ...
          <p
            ...
            title="Nothing on this page is estimated, interpolated or filled in. Where DIME withholds a number this page prints a sentence saying so."
          >
            Read off dimeindustries.com, 17 August 2026. Every figure carries the
            page it came from.
          </p>
        </header>
        ...
        <section className={styles.lever} aria-labelledby="lever-title">
          <div className={styles.leverIntro}>
            ...
            <p className={styles.leverText}>
              ...
              into weekday hours by DIME's own published terms, and{" "}
        ...
        <section className={styles.group} data-kind="priced">
          <header className={styles.groupHead}>
            ...
            <p className={styles.groupNote}>
              ...
              than a filter problem: DIME publishes no price for anything
          ...
          {visible.priced.length === 0 ? (
            <p className={styles.empty}>
              Nothing to show. DIME publishes no price for any package, so
        ...
        <section className={styles.group} data-kind="gated">
          <header className={styles.groupHead}>
            ...
            <p className={styles.groupNote}>
              ...
              Every card below prints the sentence DIME's page actually
        ...
        <section className={styles.panels} aria-label="Published terms">
          <article className={styles.panel} id="standard-terms">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              aria-label="Read the party booking page on dimeindustries.com, opens in a new tab"
            >
              <span aria-hidden="true" className={styles.sourceGlyph}>
                ◆
              </span>
        ...
        <section className={styles.chain} aria-labelledby="chain-title">
          <h2 className={styles.sectionTitle} id="chain-title">
            What DIME publishes, and what it does not
          </h2>
          ...
          <div className={styles.chainGrid}>
            <article className={styles.chainCol} data-kind="published">
              ...
              <p className={styles.chainColNote}>
                Named on DIME's own corporate profile page as venue
                features across the chain. Not one of them is a claim about
                the Irvine office, where nobody bowls.
              </p>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                aria-label="Read DIME's corporate profile page on dimeindustries.com, opens in a new tab"
              >
                <span aria-hidden="true" className={styles.sourceGlyph}>
                  ◆
                </span>
          ...
          */}
          <div className={styles.clash}>
            ...
            {/* What has actually been published, which is what a rep can
                ...
                lanes" off another operator's page, and DIME publishes no
