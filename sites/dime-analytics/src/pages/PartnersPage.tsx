 ...
 *
 * A second posting, at DIME in Irvine, files three sentences under
 ...
 * fact about DIME, and a table of Disney, Sanrio and Warner Bros.
 ...
 * The DIME posting asks for anime and game properties and this
        ...
        <header className={styles.head}>
          ...
          <p className={styles.framing}>
            ...
            <span>
              ...
              licences; DIME holds no agreement with any of them.
            </span>
          </p>
        </header>
