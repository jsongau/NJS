 ...
 * mechanic, and DIME publishes none of those anywhere either. So every
 ...
 * goes with it. Nothing on this screen is a claim about how DIME pays
 * anybody.
 *
  ...
  return (
    <section className={styles.section} aria-labelledby="pay-plan">
      ...
      >
        ...
        left column is a claim about DIME.
      </SectionHead>
      ...
      <p className={styles.para}>
        ...
        DIME publishes no trading calendar of any kind and this application
  ...
  return (
    <section className={styles.section} aria-labelledby="pay-published">
      <SectionHead
        ...
        title="What DIME publishes about pay, which is nothing"
        id="pay-published"
      >
      ...
      <p className={styles.callout}>
        ...
        <strong>
          ...
          accelerator and no bonus mechanic is published by DIME anywhere
        ...
        prototype, and not a claim about how DIME operates.
      </p>
    </section>
  );
}
