 ...
 * top, that DIME publishes no price for any of this. A prospect finds
...
function LinkNotFound({ sheetTag: Sheet = "main", sheetClassName }: SheetShape) {
  return (
    <Sheet className={[styles.sheet, sheetClassName].filter(Boolean).join(" ")}>
      <p className={styles.eyebrow}>DIME, group events</p>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.body}>
          ...
          {VENUE.postalCode}. DIME publishes {VENUE.phone} as its customer
  ...
  return (
    <footer className={styles.footer}>
      ...
      <p className={styles.disclaimer}>
        An independent work sample by Nathan J. Song, built for a DIME
        promotion planner application. Not affiliated with, endorsed by or
        connected to DIME Industries, LLC No DIME logo, wordmark or
    ...
    <Sheet className={[styles.sheet, sheetClassName].filter(Boolean).join(" ")}>
      ...
      <section className={styles.section} aria-labelledby="venue-h">
        ...
        <div className={styles.notice}>
          ...
          <p className={styles.noticeBody}>
            ...
            as you. DIME publishes what is in the package, in full, and
          ...
          <p className={styles.sourceLine}>
            ...
            rel="noreferrer"
          >
              DIME's own page for the nearest store
            </a>
          </p>
        </div>

        <p className={styles.body}>
          Everything below is published by DIME chain-wide, on its own
          corporate profile page. Spo-cha is published as available at
          select locations only and DIME does not publish which, so it is
      ...
      {pkg ? (
        <section className={styles.section} aria-labelledby="pkg-h">
          ...
          <p className={styles.body}>
            This is what DIME publishes as being in it. Not a summary of
        ...
        <div className={styles.calc}>
            ...
            <div className={styles.calcRows}>
              ...
              <div className={styles.calcRow}>
                ...
                <span className={styles.calcRowNote}>
                  ...
                  DIME publishes no lane count for any location, so this
                ...
                <span className={styles.calcRowValue}>
                  {pkg?.pricePerGuest != null ? (
                    ...
                    <WithheldFigure
                      reason={
                        <>
                          DIME&apos;s page for this package tells you to
          ...
          {belowMinimum && pkg?.minGuests != null ? (
            <p className={styles.flag}>
              <span aria-hidden="true">▲</span>
              <span>
                <strong>Under the published minimum.</strong> DIME
          ...
          {aboveMaximum && pkg?.maxGuests != null ? (
            <p className={styles.flag}>
              <span aria-hidden="true">▲</span>
              <span>
                <strong>Over the published maximum.</strong> DIME
      ...
      {/* -------------------------------------------------------
          ...
          is what DIME already publishes plus a date held while a
            ...
            <p className={styles.sourceLine}>
              ...
              <span className={styles.sourceNote}>
                {offer.provenance === "public"
                  ? "The terms in this offer are published by DIME."
                  : "This offer was written for a work sample and is not a published DIME programme."}
              </span>
            </p>
          </div>
        </section>
