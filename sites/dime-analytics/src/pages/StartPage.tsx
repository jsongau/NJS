 ...
 * Irvine needs any of it. The work was doing the arguing and the work
    ...
    <div className={styles.page} data-sec="none">
      <main className={styles.wrap}>
        <header className={styles.mast}>
          ...
          <h1 className={styles.title}>DIME</h1>
        ...
        */}
        <p className={styles.flag}>
          This is not a DIME product. It is not affiliated with,
          endorsed by, or connected to DIME Industries, LLC, and
        ...
        <section className={styles.block}>
          ...
          <p>
            Nothing about DIME's own trading is real here, because
        ...
        <section className={styles.block}>
          ...
          <ul className={styles.list}>
            <li>
              Not a proposal. Nothing here recommends that DIME do
