 ...
 * The mark at the Irvine office is DIME Industries, LLC's
...
export function TradeAreaPage() {
  ...
  */
  ...
  return (
    <FullBleedRoute label="Maps, the Irvine trade area board">
      <MapBoard
        nowMonth={NOW_MONTH}
        screenName="Maps"
            ...
            */}
            ...
            <div className={styles.ringsBody}>
              ...
              <p>
                ...
                runs straight back to the Irvine office; the other is the same
