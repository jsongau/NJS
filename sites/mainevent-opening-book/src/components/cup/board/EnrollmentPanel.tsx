 ...
 * The building has not opened, so the cup running now is a declared
 * exhibition and every score in it is labelled. Enrolling is different in
 * kind. Putting a team down for January is a thing a person can genuinely
 * do before a building opens, and it is the entire premise of this
 * application, so the panel is built like something you would actually
 ...
 * sixteen for a reason that is a property of the building: a published
 * floor of lanes, two lanes to a match, eight matches on a pair each. It
 * is not a marketing number and it cannot be quietly raised.
 *
 ...
 * Main Event publishes no dollar amount for a league anywhere, and
          ...
          <div className={styles.slots}>
            ...
            <p className={styles.slotsWhy}>
              ...
              <span>
                ...
                <span className="num">{LANES_PER_CUP_MATCH}</span> lanes and the
                building publishes{" "}
                <span className="num">{VENUE.bowlingLanesPublishedFloor}</span>.
                The scarcity is a property of the lanes rather than a line of
                copy.
              </span>
            </p>
          </div>
