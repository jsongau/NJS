    ...
    >
      ...
      >
        ...
        <EstablishedFigure
          ...
          rule={`Handicap will be (${cup.handicapBasis} minus the average) times ${cup.handicapFactorPct} per cent, truncated to a whole number. That basis and that factor are this proposal's own. Main Event publishes no handicap system.`}
        />
      </CupBlock>
