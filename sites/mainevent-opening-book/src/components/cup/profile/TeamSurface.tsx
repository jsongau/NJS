 ...
 * application's own proposal and never as a Main Event price. Main Event
    ...
    >
      ...
      <CupBlock title="Team average">
        <EstablishedFigure
          ...
          rule={`Handicap will be ${cup.handicapFactorPct} per cent of ${cup.handicapBasis} once there are averages to compute one from. That basis is this proposal's own and Main Event publishes no handicap system.`}
        />
      </CupBlock>
    </CupDialog>
  );
