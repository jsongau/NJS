        ...
        <ul className={styles.entries}>
          <li className={`${styles.entry} ${styles.entryStacked}`}>
            ...
            <span className={styles.entryText}>
              <strong>The venue, not open yet.</strong> A broken ring, because
              a solid pin would say there is a business here. There is an
              address, a phone number and no published opening date.
            </span>
          </li>
          ...
          <li className={styles.entry}>
            ...
            <span className={styles.entryText}>
              ...
              and five miles as the crow flies from Birch Street. These are not
