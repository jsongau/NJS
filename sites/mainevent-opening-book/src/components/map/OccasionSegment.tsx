 ...
 *
 * The ask was to separate the schools from the places like Samyang, and
 * the honest answer is not a category dropdown. It is the OCCASION CLASS
 * split, which is already the sharpest line in the domain model. A high
 * school books grad night because there is a graduation: the date is not
 * negotiable, it was set years ago by a term calendar, and a venue that
 * misses the window has missed a year. Samyang America books a holiday
 * party because somebody decided to: real budget, no date until a person
 * picks one, cancellable right up until it happens. Those are two
 * different sales calls made in two different months, and they are not
 * two kinds of business at all. Sorting by industry would have put a
 * dojang and a dental group in different buckets while hiding the thing
 * that actually decides when you ring them.
 *
 * ---------------------------------------------------------------
 ...
 *
 * THE SENTENCE UNDERNEATH IS NOT DECORATION. "Calendar buys, not the
 ...
 * such as two schools lanes and one corporate lane, is a narrower thing
  ...
  return (
    <div className={styles.group}>
      ...
      <p className={styles.note} id={noteId}>
        Calendar buys, not the buyer. A graduation happens anyway; a party
