 ...
 * It does not invent a discount: Main Event publishes no corporate price
 * at all, so there is nothing to take a percentage off, and the only
 * pre-opening leverage this desk has is priority and certainty.
 */
      ...
      >
        ...
        <div className={styles.scroller} ref={scrollRef}>
          ...
          <Panel id="potential" active={active === "potential"}>
            ...
            <dl className={styles.facts}>
              ...
              <Fact label="Bowling lanes">
                ...
                />
                <span className={styles.hint}>
                  Main Event publishes one lane per{" "}
                  <span className="num">{GUESTS_PER_BOWLING_LANE}</span>{" "}
                  guests. At the midpoint of{" "}
                ...
                {record.bookLines.length > 0 ? (
                  ...
                  <>
                    <Figure
                      ...
                      withheldReason={`${leadPackage ? leadPackage.name : "The lead package"} is one Main Event gates behind a sales manager, which is the reason this role exists.`}
                      compact
                    />
                    {leadValue === null ? null : (
                      <span className={styles.hint}>
          ...
          {/* -------------------------------------------------------
              ...
              the venue. Never a discount: Main Event publishes no
              corporate price to take a percentage off, and the leverage
              before opening is priority and certainty.
              ------------------------------------------------------- */}
