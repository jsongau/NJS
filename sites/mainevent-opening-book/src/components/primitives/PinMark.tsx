...
/**
 * THE MARK: a bowling ball in play, inside the dial that is counting down
 ...
 * The venue is bowling, an arcade, laser tag and a ropes course. A pin is
 * the object that has already been knocked over by somebody else. A ball
 ...
 * the venue in one shape, and it is a shape nobody owns. There is no
 * wordmark here, no lockup, no sampled brand colour and no red.
 *
