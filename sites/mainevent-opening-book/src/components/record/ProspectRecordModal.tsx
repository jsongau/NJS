 ...
 * Main Event publishes no corporate price at all, so a percentage off
 * one would be a discount off a secret. What is extended before opening
 * is priority and certainty: first pick of a date, a locked rate, a hard
 * hat walk. The cost to the venue is read from the offer catalogue in
 * the words the catalogue uses, rather than restated as a number whose
 * unit a reader would have to guess.
 */
        ...
        <div className={styles.body}>
          ...
          <section className={styles.section} aria-labelledby="rec-offers">
            ...
            <p className={styles.sectionNote}>
              Priority and certainty, never money off a published price.
              Main Event publishes no corporate price to discount.
            </p>
