 ...
 * headcount that a person skipped and a blank headcount that Main
 * Event's own Brea form never asked for look identical in every CRM ever
 * built, and they are two completely different problems. The first is
        ...
        <dl className={styles.facts}>
          ...
          {r.freeTourRequested !== null ? (
            <div className={styles.fact}>
              ...
              <dd>
                {r.freeTourRequested
                  ? "Ticked. Offered by the brand-wide form, not by Brea's."
          ...
          <>
            <p className={styles.laneMaths}>
              ...
              <span className={styles.laneWords}>
                bowling lanes for{" "}
                <span className="num">{r.headcount}</span> guests, at Main
                Event's published one lane per{" "}
                ...
                lanes and no exact count.
                <ProvenanceBadge provenance="public" compact />
              </span>
            </p>
            {lanesForGuests(r.headcount) > VENUE.bowlingLanesPublishedFloor ? (
              <p className={styles.laneWarn}>
                <span aria-hidden="true">◉</span>
                <span>
                  Past the published floor for one sitting. Full facility, or
                  two sittings.
                </span>
              </p>
            ) : null}
    ...
    <>
      ...
      <section className={styles.section} aria-labelledby="rd-league-real">
        ...
        <p className={styles.leagueLead}>
          ...
          <em>{programme.registrationStatus}</em> on Main Event's own leagues
          page.
          <ProvenanceBadge provenance="public" compact />
        </p>
  ...
  return (
    <>
      ...
      <p className={styles.footWhy}>
        {l.prospectId
          ? "Brea is not one of the named locations, so the draft opens blank."
