 ...
 *
 * ---------------------------------------------------------------
 * MAIN EVENT HAS NOT ANNOUNCED A CUP
 * ---------------------------------------------------------------
 *
 * There is no quarterly cup on mainevent.com, no cup calendar, and no
 * entry fee published for anything of this kind. The brand publishes one
 * league programme, Open Lane Socials, which is recorded in
 * `data/requests.ts` with the five facts it states and the five it
 * withholds, and Brea is not named on it. So everything in this file is
 * A PROPOSED PROGRAMME and every row in it is badged illustrative. It is
 * this application's own proposal for what a new bowling house could run,
 * not a claim about how Main Event operates.
 *
 * ---------------------------------------------------------------
 * THE CUP RUNNING NOW HAS NOT BEEN BOWLED
 * ---------------------------------------------------------------
 *
 * The Founders Cup below carries scores. Nobody has bowled a frame in
 * this building and every one of those scores is generated. It is a
 ...
 * presented as real product, because enrolling a team is a thing a person
 * can genuinely do before a building opens.
 *
 * ---------------------------------------------------------------
 * THE FEE
 * ---------------------------------------------------------------
 ...
 * everywhere it renders. Main Event publishes no league price and no cup
 * price; neither does Bowlero and neither does Lucky Strike. It is not
 ...
 * final bowled on two lanes of a published twenty six. The building is
 * emptier on the biggest night of the quarter than on any other night of
 * it.
 *
...
const FEE_NOTE =
  "The venue's own, invented for this prototype, and not a claim about how Main Event operates. Main Event publishes no dollar amount for a league or a cup anywhere, and neither does Bowlero or Lucky Strike.";
...
export const CUPS: Cup[] = [
  ...
  },
  {
    ...
    note: "The field is sixteen because twenty six lanes and two lanes to a match make it sixteen. That scarcity is a property of the building rather than a line of copy, and the deadline closes.",
    provenance: "illustrative",
  },
  {
...
export const CUP_ENTRIES: CupEntry[] = [
  ...
  /* Eleven of sixteen for January. The five free slots are the product:
     they are what a team can still claim, and the count is a physical
     property of a building with twenty six lanes rather than a line of
     copy written to create urgency. */
  ...[
