    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "The reason is the same one that put nine verified real organisations on an exclusion list rather than on the board. A plausible invented name sitting next to a hundred and two real organisations is the fastest way to make a reader doubt the real rows. Nobody reads a handle and believes a specific human is being described.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "The disclaimer is a running element so it appears on every printed page rather than only the first, and links lose their printed URL suffix, because a URL after every link is noise in a document somebody is going to write on.",
