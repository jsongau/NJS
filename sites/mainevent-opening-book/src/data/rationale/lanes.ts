    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "The discretionary side has a season of its own and it is worth naming. Executive assistants and HR research holiday venues in July and August, the decisions land from August to early October, and October is the highest inquiry month. So the corporate ask is made in summer, ahead of the month everybody else is asking in.",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Sixteen rows are taller than a viewport. Pressing Reach can move six sectors below the fold while the top three sit still, and a reader watching the top three sees a page that did nothing. So every row carries how far it moved against the default weighting as an arrow and a word and a number, and a polite status region under the presets says how many rows changed place and names the biggest mover before anybody has to scroll to find it.",
    ...
    sections: [
      {
        ...
        body: [
          "Of the 211 organisations on this board, 93 have a named contact and a published source URL, 50 have a contact form and nothing else, and 68 have no email door at all. Not a hard one to find. None.",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Some lanes are a route by nature and some are a set of appointments, and the map is where the difference is visible. Local retail and food has more organisations within half a mile of the venue than any other lane has within six, which is why those fifteen are worked as a walking line rather than as fifteen accounts with fifteen diary entries.",
      ...
      },
      {
        ...
        body: [
          "The first pass of the prospect list came out of the Google Places API on 11 August 2026 and every one of those rows carries the place id it came from, so any pin can be checked at source in about fifteen seconds. A later pass of local retail, food, auto service and small employers was researched by reading each organisation's own published page or its landlord's tenant directory and then geocoded with the US Census Bureau geocoder. Those rows carry no place id at all: the field is absent rather than filled, because there was no Places call in that pass and a fabricated id on a row a reader might click is worse than a missing one.",
          "Some researched organisations are real and have no mark on this map. Seven could not be matched by the Census geocoder, whose address ranges lag new construction, which is why newer centres failed while every older Brea Boulevard address matched first time. Two are worse and more interesting: the geocoder came back with a different street from the one the research pass had read. The alternative was to nudge a nearby pin, and a fabricated pin is the one thing that would discredit every other mark on the screen. An unmatched row is a fact somebody can act on, so those names are published as removed, with the reason, rather than plotted.",
