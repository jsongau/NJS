    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "The two kinds of message are separated for the same reason. An outreach letter and a quote are not the same act. A quote carries a package and a headcount, and it is a number a buyer may carry into a meeting with somebody who controls the money. Quotes get chased first, and a quote that has sat quiet for a week is a phone call, not a resend.",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          "Five messages arrived with the build so the log has a pattern in it: five lanes, three kinds of message, five different outcomes and only one of them good, which is the honest ratio for cold outreach from a building nobody has heard of.",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Every row prices its own answer, and that is the line to read first. Three of these cost no cash at all. A place in line is a hold at no cost that converts or releases the day a date is published, and what it spends is optionality on a calendar that is currently empty. A hard hat tour spends an hour and a conversation with the general contractor. The answer on the competitor row spends nothing whatsoever and buys the buyer's trust for the rest of the relationship.",
