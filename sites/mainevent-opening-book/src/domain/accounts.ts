...
export const SEGMENT_PROFILE: Record<AccountSegment, SegmentProfile> = {
  ...
  "senior-living": {
    ...
    source:
      "Read off Silverado Brea's own reply in SEED_REPLIES, which asked for a weekday daytime staff appreciation for about forty split across two shifts. A rolling occasion tied to shift patterns rather than to a season.",
    provenance: "modeled",
  },
};
