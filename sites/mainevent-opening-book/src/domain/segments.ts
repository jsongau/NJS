...
export const SEGMENT_META: Record<SegmentId, SegmentMeta> = {
  ...
  "81": {
    ...
    motion:
      "The offer, not the sale. A published Spirit Night fundraiser that donates a share of sales turns 'buy a party' into 'we will raise money for you', which is the only version a volunteer committee with no budget can approve. Repair and personal-care businesses in this sector are a different, smaller thing worked as a walking route.",
    friction:
