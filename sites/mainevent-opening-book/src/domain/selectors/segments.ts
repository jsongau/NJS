 ...
 * THE SEGMENT BOARD.
 *
 * The literal answer to one line of the Brea posting:
 *
 ...
 * price, and prices for group packages are the one thing Main Event
 ...
 * holiday party is a decision somebody can simply not make. Before a
 * venue opens, that difference is the whole asset, which is why it is
 * weighted above reach.
 *
 ...
 * hour out of the building is the scarcest thing a pre-opening sales
 * manager has.
 *
