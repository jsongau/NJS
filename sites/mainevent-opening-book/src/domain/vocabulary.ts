 ...
 *
 * Nothing in here invents anything about Main Event. These are names for
 ...
 *
 * The notes below describe Main Event's own published behaviour and
 * nothing more. The corporate family is unpriced because mainevent.com
 * publishes no price for it, not because this app decided to withhold
 * one.
 */
export const PACKAGE_FAMILY: Record<PackageFamily, FamilyToken> = {
  corporate: {
    ...
    note: "Unpriced on mainevent.com and gated behind a local sales manager. This family is the reason the role exists.",
  },
  "youth-group": {
    label: "Youth group",
    glyph: "▥",
  ...
  fundraiser: {
    ...
    note: "Spirit Night and Play It Forward. A community door-opener before it is a sale, and the group brings its own crowd.",
  },
};
 ...
 * same colour, because a pre-opening report is precisely where hours out
 * of the building get quietly dressed up as results.
 */
export const LEDGER = {
  "booked-revenue": {
    glyph: "●",
