      ...
      <div className={styles.inner}>
        ...
        <header className={styles.head}>
          ...
          <p className={styles.framing}>
            ...
            <span>
              A clock, not a history. The venue has not opened, both signed
              contracts are still in front of it, and no back catalogue has
              been invented. Retained revenue is the same book money seen
              down a second axis and never a third ledger.
            </span>
          </p>
        </header>
 ...
 * records about a venue that has not opened, which would cost the
