    ...
    return [
      {
        ...
        note: `Whole teams still to find for ${next.name}. The field is ${enrollment.field} because a match takes ${LANES_PER_CUP_MATCH} lanes of a published ${VENUE.bowlingLanesPublishedFloor}.`,
        tone: "var(--warn)",
      ...
      },
      {
        ...
        note:
          held.length === 0
            ...
            : `${held.map((e) => e.team.name).join(" and ")} are holding a place under the pre-opening offer and have not confirmed.`,
        tone: "var(--info)",
      ...
      <div className={styles.inner}>
        ...
        <header className={styles.head}>
          ...
          <p className={styles.framing}>
            ...
            <span>
              A proposed programme, not an announcement. Main Event has not
        ...
        {nextView && next ? (
          <section className={styles.section} aria-labelledby="cup-enrol">
            <SectionHead
              ...
              lede="Real product. A team can be put down before the doors open, and that is the whole premise of this application."
              meta={
                <>
        ...
        <section className={styles.section} aria-labelledby="cup-fixtures">
          ...
          <StatStrip label="The format, in figures derived from the field">
            ...
            <Stat
              ...
              note={`Sixteen lanes of the ${VENUE.bowlingLanesPublishedFloor} Main Event publishes, on every one of the six nights including the finals.`}
              provenance="modeled"
            />
            <Stat
        ...
        <section className={styles.section} aria-labelledby="cup-cadence">
          ...
          <p className={styles.sectionFoot}>
            ...
            <Link to="/leagues">leagues</Link>. The lane arithmetic against the
            published floor of{" "}
            <span className="num">{VENUE.bowlingLanesPublishedFloor}</span>{" "}
            lanes is on <Link to="/calendar">capacity</Link>, and every formula
            is on <Link to="/method">method</Link>.
          </p>
        </section>
      </div>
 ...
 * carry is the right one here: Main Event publishes no price and has
 * announced nothing at Brea, which is exactly as true of a cup as it is
 * of a league.
 *
