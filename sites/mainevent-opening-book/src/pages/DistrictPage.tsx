 ...
 *   ?as-of=2026-12-27  past the pre opening calendar. The band is a
 *                      continuation rather than a seeded period, both
 *                      contracts are behind the venue, and every one of
      ...
      <div className={styles.inner}>
        ...
        <article className={styles.sheet}>
          <div className={`${styles.masthead} avoid-break`}>
            <div className={styles.mastheadTop}>
              <p className={styles.sheetEyebrow}>
                The Opening Book, district report
              </p>
            ...
            <dl className={styles.headline}>
              <Figure
                ...
                note={
                  period.weeksToOpen > 0
                    ? "Counted in weeks. No opening date is published."
                    : `Past the modelled opening of ${formatDate(MODELLED_OPENING)}.`
                }
              />
              <Figure
            ...
            <p className={styles.mastheadNote}>
              <span aria-hidden="true">▲</span>
              <span>
                {period.basis} Main Event publishes no opening date and no hours
                for Brea, so the countdown above is this plan&apos;s own
                numbering in weeks rather than a date anybody has announced.
                Nothing on this page is a claim about how Main Event runs a
                district.
              </span>
            </p>
          </div>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.sectionNote}>
              ...
              exact reason: a pre opening report is where hours quietly get
              ...
              <div className={`${styles.ledger} avoid-break`}>
                ...
                <dl className={styles.ledgerFigures}>
                  ...
                  <Figure
                    ...
                    note="Main Event publishes no price for gated group packages, so this share of the total came off this desk rather than off a rate card."
                  />
                </dl>
              </div>
            ...
            <div className={`${styles.pace} avoid-break`}>
              ...
              {!previous ? null : (
                <p className={styles.paceFoot}>
                  ...
                  there cannot be, because the building has not opened. Every
                  pace figure in the hospitality literature is defined against a
                  prior year this venue does not have, so the comparison is
          ...
          <section className={styles.section}>
            ...
            <p className={styles.sectionNote}>
              ...
              regardless. The release date is derived from Main Event&apos;s own
              published minimum booking notice of{" "}
              <span className="num">{STANDARD_TERMS.bookingNoticeDays}</span>{" "}
              days: after it, the hold can no longer convert into a booking on
              the published terms for the date it is holding.
            </p>
            {holds.length === 0 ? (
                        ...
                        <dd>
                          {h.lanes === null ? (
                            ...
                            <>
                              ...
                              <span className="num">
                                {VENUE.bowlingLanesPublishedFloor}
                              </span>
          ...
          <p className="print-only print-disclaimer">
            The Opening Book. An independent work sample by Nathan J. Song, built
            for a Main Event Brea Sales Manager application. Not affiliated with,
            endorsed by or connected to Main Event Entertainment. Addresses,
            package terms and the published booking notice were read from
            published sources on 11 August 2026. Period bands, offers, holds and
        ...
        <div className={`${styles.method} no-print`}>
          ...
          <ul className={styles.methodList}>
            ...
            <li>
              Release dates are the published five day booking notice subtracted
              from the held date. Lane counts are Main Event&apos;s published one
              lane per twenty guests against the published floor of{" "}
              {VENUE.bowlingLanesPublishedFloor}, which is also what{" "}
              <Link to="/calendar">Capacity</Link> computes against.
            </li>
            <li>
