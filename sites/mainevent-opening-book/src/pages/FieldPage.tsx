 ...
 * posting for Sales Manager at Main Event Brea lists its daily
 * responsibilities in order, and the first one is:
 *
 ...
 * centre of that sentence are the ones a pre-opening venue cannot get
 * around. There is no client base. There is no walk-in traffic, because
 * there is no door to walk in through yet. There is no CRM history to
 * mine, because nobody has ever sold anything from this address. What
 * there is, is a trade area full of organisations who do not know the
 * building exists, and one person with a car.
 *
 * ---------------------------------------------------------------
 ...
 * city's largest single-site employers, a few hundred feet apart, naming
 * the same job title as the buyer. One table, one lunch hour, both of
 * them. A call block does not reproduce that afternoon at any price.
 *
 ...
 *
 * Nothing here invents a Main Event fact. The venue address and phone
 ...
 * asks a hundred times, which is how far a prospect is from 245 W Birch
 * Street. This answers a different one that only the tabling section
 * needs: how far two prospects are from EACH OTHER. That is the whole
 * Kraemer Boulevard argument reduced to a number, and it is computed from
 * the two Google Places coordinates rather than asserted, so a reader who
 * doubts it can check both rows on the trade area map.
 *
 ...
 * does not count. It is outbound work, it is real, and it happens at 245
 * W Birch Street, which is the one address in this application that is
...
export function FieldPage() {
  ...
  /* The run. Sorted by straight-line distance from 245 W Birch Street,
      ...
      <div className={styles.inner}>
        <header className={styles.head}>
          ...
          <blockquote className={styles.posting}>
            ...
            <cite>
              The first daily responsibility on the Sales Manager posting for
              Main Event Brea
            </cite>
          </blockquote>
        ...
        <section className={styles.kpis} aria-label="The period at a glance">
          ...
          <Kpi
            ...
            note={`This app holds itself to ${Math.round(OUTSIDE_SHARE_FLOOR * 100)}% or better. That bar is this app's own and Main Event publishes no such figure.`}
            provenance="modeled"
          />
        </section>
        ...
        <section className={styles.section} aria-labelledby="run-h">
          <div className={styles.sectionHead}>
            ...
            <p className={styles.sectionLede}>
              ...
              all, sorted by straight-line distance from 245 W Birch Street.
            </p>
          ...
          {kraemer.length === 2 && kraemerGap !== null ? (
            <article className={styles.kraemer} aria-labelledby="kraemer-h">
              ...
              <p className={styles.kraemerLede}>
                ...
                sign off a holiday party at both of them walk past it on their
                way to lunch.
              </p>
              ...
              <div className={styles.kraemerPoint}>
                <p>
                  Both name the same buyer. Both are on the same block. One of
                  them publishes an email address and the other publishes a
          ...
          <div className={styles.split}>
            ...
            >
              ...
              <span>
                ...
                app's own and it is illustrative; Main Event publishes no such
            ...
            <div className={styles.formGrid}>
              ...
              <div className={styles.field}>
                ...
                <input
                  ...
                  placeholder="Brea Mall corridor, employer lobbies, Friday lunch hour"
                />
                <span className={styles.fieldHint}>
