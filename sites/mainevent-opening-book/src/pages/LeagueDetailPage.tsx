 ...
 * lanes, so eight matches is sixteen lanes, which against Main Event's
 * published floor of twenty six lanes is most of the house on that night.
 ...
 * ranks readiness rather than results, because this venue has not opened
 * and nothing has bowled a frame. Every figure carries its provenance and
      ...
      <div className={shared.inner}>
        <header className={shared.head}>
          ...
          <p className={shared.framing}>
            ...
            <span>
              Forming for the opening season. Main Event publishes{" "}
              <a
        ...
        <StatStrip label={`${league.name} at a glance`}>
          ...
          />
          <Stat
            value={`${view.laneSharePct}%`}
            label="Of the published floor"
            note={`Against the ${VENUE.bowlingLanesPublishedFloor} lanes Main Event publishes as a floor for Brea. The floor is used everywhere in this app, so this can only overstate the share.`}
            provenance="modeled"
          />
          <Stat
        ...
        <section className={shared.section} aria-labelledby="ld-shape">
          ...
          <div className={styles.priceBlock}>
            <WithheldFigure
              reason={
                <>
                  No dollar amount for a league appears on Main Event's own
                  leagues page. Bowlero and Lucky Strike withhold league
                  pricing the same way, so the missing figure is a category
                  habit rather than a gap in the research.
                </>
              }
            />
          </div>
        ...
        <section className={shared.section} aria-labelledby="ld-slots">
          ...
          <div className={styles.positions}>
            ...
            <p className={styles.positionNote}>
              Main Event publishes no team size and no format. Five bowlers
              and three games are this proposal's own, and the blog line
              about teams of three to five is generic education rather than a
              company rule.
            </p>
          </div>
        </section>
