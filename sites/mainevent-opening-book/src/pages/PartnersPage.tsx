 ...
 * fact about Main Event, and a table of Disney, Sanrio and Warner Bros.
 * sitting inside an application about a bowling venue would be read as a
 * deal by anybody scanning it in ten seconds.
 *
        ...
        <header className={styles.head}>
          ...
          <p className={styles.framing}>
            ...
            <span>
              ...
              licences; Main Event holds no agreement with any of them.
            </span>
          </p>
        </header>
