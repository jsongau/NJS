 ...
 * not on the events pages, not on the contact page. There is no service
 * level to quote and this screen does not invent one on their behalf.
 * The four working hour commitment is the venue's own, invented for this
 * prototype, and it says so on screen in the same block as the number
 ...
 * Main Event's Brea page carries a form asking for a name, an email, a
 * phone number, a company and 256 characters of free text. It asks for
 * no date, no headcount and no event type. The brand-wide events form
 * asks for all three. Both field sets were read off the published pages
 * on 11 August 2026.
 *
 * That difference is not a design quibble; it is a commercial hole. A
 * venue cannot quote what its own form did not collect, and every
 * enquiry through the Brea route arrives missing all three of the
 * answers a sales manager needs before they can price anything. The gap
 ...
 * A tournament. Main Event publishes no tournament programme anywhere:
        ...
        */}
        <header className={styles.head}>
          ...
          <p className={styles.subLede}>
            ...
            <span
              ...
              title="Enquiries written for this work sample. Each row carries the exact field set of the published route it arrived through, read off Main Event's own pages on 11 August 2026. Contact addresses sit on the .invalid domain, which RFC 2606 reserves so it can never resolve."
            >
        ...
        <section className={styles.gap} aria-labelledby="gap-h">
          <div className={styles.sectionHead}>
            ...
            {/* Published field sets, read off Main Event's own pages. This
                is the finding the panel exists to count, so it keeps its
                badge and its shortest true form. */}
            <p
              className={styles.sectionNote}
              title="Main Event's Brea page asks a first name, a last name, an email, a phone number, a company and 256 characters of free text. It asks for no date, no headcount and no event type. The brand-wide events form asks for all three. Both field sets were read off the published pages on 11 August 2026."
            >
              Brea's form asks for no date, no headcount and no event type. The
              brand-wide form asks for all three.
