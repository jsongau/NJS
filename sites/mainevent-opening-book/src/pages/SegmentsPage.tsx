...
const PRESETS: Record<WeightsKey, WeightPreset> = {
  balanced: {
    ...
    note: "The board's published weighting. Volume leads because guests are the closest thing to revenue that can be computed without inventing a price, and Main Event does not publish group prices.",
  },
  "pre-opening": {
    key: "pre-opening",
    label: "Pre-opening",
    ...
    certainty: 0.6,
    reach: 0.2,
    note: "Before the doors open the only prospects worth anything are the ones whose event happens whether or not you call them. A graduating class graduates. A holiday party is a decision somebody can simply not make.",
  },
  volume: {
    key: "volume",
    label: "Volume",
  ...
  reach: {
    ...
    certainty: 0.2,
    reach: 0.6,
    note: "One rep, no tour to offer, and an hour out of the building is the scarce resource. Sectors you can write to win; sectors that have to be walked lose.",
  },
};
    ...
    >
      ...
      <div className={styles.inner}>
        <header className={styles.head}>
          ...
          <blockquote className={styles.posting}>
            <p className={styles.postingText}>
              "Develop and execute a local and outbound sales strategy to
              identify high-potential target customer segments and industries
              that would benefit from our services."
            </p>
            <footer className={styles.postingFoot}>
              One line of the Main Event Brea posting. This screen is the
              answer to it.
            </footer>
          </blockquote>
                ...
                >
                  <h3 className={styles.rankHeading}>
                    ...
                    >
                      ...
                      {/* Arrow, word and number. Any two of the three can
                          fail — greyscale, a screen reader, a glyph the
                          font does not carry — and the row still says
                          what happened to it. */}
                      <span
        ...
        {/* =========================================================
            ...
            withheld glyph, a dashed edge, no rank and no score — so a
