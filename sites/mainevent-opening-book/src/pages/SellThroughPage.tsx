 ...
 *
 * Three surfaces already answer the Round1 posting from the inside.
        ...
        <header className={`${styles.head} no-print`}>
          ...
          <p className={styles.framing}>
            ...
            <span>
              ...
              the only public facts on this screen. Main Event holds no
            ...
            <article className={styles.doc} aria-live="polite">
              <header className={styles.docHead}>
                <div className={styles.docHeadMain}>
                  ...
                  <p className={styles.docMeta}>
                    ...
                    {formatDate(NOW)} by the Sales Manager, Main Event Brea. To
                    the licensor of record for {statement.licence.name}.
                  </p>
                </div>
                <div className={styles.docStamp}>
                  ...
                  <span className={styles.docStampNote}>
                    ...
                    agreement exists between Main Event and{" "}
              ...
              <footer className={styles.docFoot}>
                ...
                <dl className={styles.provList}>
                  ...
                  <div className={styles.provRow}>
                    ...
                    <dd>
                      ...
                      Mark holding these licences is a fact about Nature's Mark
                      and is not a fact about Main Event or Round1.
                    </dd>
                  </div>
                </dl>
                ...
                <p className="print-only print-disclaimer">
                  ...
                  counts. There is no agreement between Main Event and any
                  licensor named here.
                </p>
              </footer>
            </article>
