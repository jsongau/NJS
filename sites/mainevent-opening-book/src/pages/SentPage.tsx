...
/*
  ...
  one in Brea Olinda High School's seeded reply, so the two screens agree.
*/
const SAMPLE_PACKAGE_ID = "school-all-access-pass";
        ...
        <div className={styles.emptyCol}>
          ...
          <div className={styles.door}>
            ...
            <p className={styles.doorText}>
              The template forks on the lane and on the absent opening date.
            </p>
