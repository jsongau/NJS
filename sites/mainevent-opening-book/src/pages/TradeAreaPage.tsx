 ...
 * only genuinely scarce resource a pre-opening sales manager has, which is
 ...
 * behind an icon.
 *
 * ── THE VENUE MARK SAYS THE THING THE WHOLE APP IS ABOUT ──────────
 * Main Event Brea is not open. The mark at 245 W Birch Street is a BROKEN
 * ring with the words "Not open yet" under it, because a solid pin says
 * "here is a business" and a reader who accepts that reads every other pin
 * on this screen as a customer instead of as an organisation nobody has
 * spoken to. There is no client base. That is the premise.
 *
            ...
            */}
            ...
            <div className={styles.ringsBody}>
              <p>
                ...
                published coordinates. The building in the middle is not open,
                so nothing on this map is a customer yet.
              </p>
              <p>
                ...
                than of the prospect, and hours outside the building are the
                only genuinely scarce resource a pre-opening sales manager has.
              </p>
              <p>
                ...
                runs straight back to Birch Street; the other is the same
