 ...
 * seven things a pre-opening venue gets hit with, each one carrying
 ...
 * conversations in the corporate lane died on "I am not signing for a
 * venue I have not walked", that is not a coaching note about objection
 * handling, it is an argument for spending the sales manager's autumn on
 * hard hat tours. A register that only records successes cannot make that
 * argument, because the evidence for it is exactly the part it threw
 * away.
 *
...
> = {
  open: {
    ...
    glyph: "○",
    cssVar: "var(--warn)",
    note: "Live and unanswered. Before the doors open, most of this register should be sitting here, and a register that is not is probably not being read.",
  },
  answered: {
    label: "Answered",
    glyph: "●",
