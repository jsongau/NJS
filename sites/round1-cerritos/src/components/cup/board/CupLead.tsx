    ...
    <div className={styles.lead}>
      ...
      <section className={styles.now} aria-labelledby="cup-now">
        ...
        <dl className={styles.facts}>
          ...
          {/*
            The sub-line was a percentage of the house and is now a
            statement that there is no house figure. `view.laneSharePct`
            is null, because Round1 publishes no bowling lane count for
            any location and a share needs a denominator. The lanes a
            cup night takes is a real number and it stays.
          */}
          <div className={styles.fact}>
