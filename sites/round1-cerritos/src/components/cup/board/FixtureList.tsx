        ...
        return (
          ...
          >
            <div className={styles.nightHead}>
              ...
              {/*
                The share of the house came off this line because
                `laneSharePct` is null on every night. Round1 publishes
                no lane count for any location, so there is nothing to
                take a percentage of, and printing one off the count the
                fork inherited would have been a figure about somebody
                else's building. The lane count this programme itself
                asks for is untouched, and it is the half that was ever
                ours to state.
              */}
              <span className={styles.nightFacts}>
                <span className="num">{night.matches}</span> matches,{" "}
                <span className="num">{night.lanes}</span> lanes, house lane
                count not published
              </span>
