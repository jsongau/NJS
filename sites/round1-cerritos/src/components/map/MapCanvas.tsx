 ...
 * word: everything on this map is arranged around one office in
 * Cerritos.
 *
 ...
 * A solid pin on a map says "here is a place you can walk into". 12900
 * Park Plaza Drive is Round One Entertainment's US corporate head office.
 * Nobody bowls there, there is no arcade and no party room, and a reader
 * who takes the centre of this map for a store misreads the distances:
 * the nearest place a group could actually go is the Lakewood Center
 * store, which is a mark of its own. So the ring is dashed rather than
 * solid, it carries a plate of words under it, and neither of those
 * depends on the amber.
 *
 ...
 * pixels wide, because it carries a plate of words under the ring, and
 * that plate reaches 52 pixels either side of the
 ...
 * "Send a featured promo", on the reasoning that the featured offer could
 * otherwise be sent from the panel and from nowhere on the map. The
 ...
 * quadrant of the trade area: the organisations run north east and due
 * south of Park Plaza Drive, so a label placed there sat over the fewest
 * pins. That is a true
...
function FitToFilter({
  ...
  useEffect(() => {
    ...
    /*
      ...
      of one lane that has scrolled 12900 Park Plaza Drive off the edge
      has lost the only fixed point on it. A go-see run is the exception and
    ...
    >
      ...
      */}
      <p className="visually-hidden" role="status" aria-live="polite">
        {rows.length} organisations plotted around Round1's Cerritos head
        office. {summary.insideThree} of them are inside three straight line miles,{" "}
        ...
        straight line miles from 12900 Park Plaza Drive, and they are not
        drive times.
        ...
        */}
        ...
        {ringLabel ? (
          <Marker
            ...
            */
            title={`${ringLabel.ring.miles} straight line miles from 12900 Park Plaza Drive, not a drive time. ${ringLabel.ring.note}`}
            interactive={false}
            keyboard={false}
        ...
        {/*
          ...
          latitude, and there are organisations north of Park Plaza Drive
          that would otherwise sit on top of the one building this entire
          application is about.
        */}
        <Marker
          position={VENUE_POINT}
          icon={venueMark}
          title={`${VENUE.name}, US head office. Not a store.`}
          zIndexOffset={1000}
        >
          <Popup
          ...
          >
            <div className={styles.popup}>
              <p className={styles.popupKicker}>The office</p>
              ...
              <p className={styles.popupNotOpen}>
                <span aria-hidden="true">◌</span> Not a store. This is Round
                One Entertainment's US corporate head office, and no page on
                round1usa.com claims there is bowling, an arcade or a party
                room at this address. The number is Round1's published
                customer support line rather than a desk in this building.
              </p>
