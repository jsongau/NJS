 ...
 * its drawing and what the drawing is, in words. The venue, the cluster
        ...
        <ul className={styles.entries}>
          <li className={`${styles.entry} ${styles.entryStacked}`}>
            ...
            <span className={styles.entryText}>
              <strong>The office, not a store.</strong> A broken ring, because
              a solid pin would say a group could walk in here. This is Round
              One Entertainment's US corporate head office, and no page on
              round1usa.com puts bowling, an arcade or a party room at this
              address.
            </span>
          </li>
          ...
          <li className={styles.entry}>
            ...
            <span className={styles.entryText}>
              ...
              and five miles as the crow flies from Park Plaza Drive. These are not
