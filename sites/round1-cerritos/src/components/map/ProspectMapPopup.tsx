 ...
 * explaining where the headcount came from, and three buttons. Measured
 ...
 * person, so WRITTEN DOOR, FROM THE BUILDING and WHO SIGNS were each
 ...
 *
 * The headcount basis went with them, whole. It is a sentence and a half
    ...
    <div className={styles.popup}>
      ...
      */}
      <ul className={styles.facts}>
        ...
        {/*
          Both figures on one line, because they are the two numbers a rep
          weighs against each other: how far to drive and how many people
          are at the end of it. "Straight line" stays in the visible words
        ...
        */}
        <li className={styles.figures}>
          <span className={styles.figure}>
            <span className="visually-hidden">From the building: </span>
            <Figure
          ...
          <span className={styles.figure}>
            <span className="visually-hidden">Likely group: </span>
            {/*
              A range, never a midpoint. The headcount is the input to
            ...
            */}
            <Figure
              value={`${p.headcountLow} to ${p.headcountHigh} guests`}
