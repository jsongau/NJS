 ...
 *
 * No price for a gated package, and no lane count. Where Round1 publishes
          ...
          <section className={styles.section} aria-labelledby="sec-where">
            ...
            <dl className={styles.facts}>
              ...
              <div className={styles.fact}>
                ...
                <dd>
                  <span className="num">{miles.toFixed(1)}</span> miles from{" "}
          ...
          <section className={styles.section} aria-labelledby="sec-size">
            ...
            <div className={styles.lanesBox}>
              <p className={styles.lanesLead}>
                ...
                {lanesNeeded === 1 ? "lane" : "lanes"}.
              </p>
              {/*
                WHAT IT CONSUMES THEM OUT OF IS THE ONE THING NOBODY CAN
                SAY. The lead line used to finish with a share of a lane
                count the forked operator published for its own building.
                Round1 publishes no lane count for any location, so there
                is no denominator, and a share of an unpublished total is
                a percentage of nothing. The sentence stops where the
                published facts stop.
              */}
              <p className={styles.lanesNote}>
                <WithheldFigure reason="Round1 publishes no lane count for any location, and none for Lakewood Center, the nearest store to this office. So this figure is a size, not a share, and there is no percentage of the building to quote off it." />
              </p>
              <p className={styles.lanesNote}>
                The rate of one lane per{" "}
                <span className="num">{GUESTS_PER_BOWLING_LANE}</span> guests is
                this application's own planning assumption rather than a
                published Round1 rule, which is why the block is badged
                modeled and not public.
              </p>
