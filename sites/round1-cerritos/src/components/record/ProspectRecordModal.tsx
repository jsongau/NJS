 ...
 * Round1 publishes no group price at all, so a percentage off one would
 * be a discount off a secret. What is extended is certainty: the
 * contents of the one package Round1 itemises in public, and the one
        ...
        <div className={styles.body}>
          ...
          <section className={styles.section} aria-labelledby="rec-offers">
            ...
            <p className={styles.sectionNote}>
              Certainty, never money off a published price. Round1 publishes
