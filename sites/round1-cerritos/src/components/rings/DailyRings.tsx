 ...
 * is three things at once: a MARK, the strike box a bowling scoresheet
 * already uses for a cleared rack, stamped on the ring; a CHANGE OF
  ...
  return (
    ...
    >
      ...
      */}
      ...
      {reading.allClosed ? (
        /* THE DAY, CLEARED. A strike box, two words and the three
...
function RingButton({
  ...
  return (
    ...
    >
      ...
      {/*
        THE STAMP. A closed ring gets the strike box a scoresheet marks a
        cleared rack with, laid over the top right of the arc. It is the
