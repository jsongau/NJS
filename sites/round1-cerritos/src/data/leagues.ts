 ...
 * screen in this application presents it as Round1's.
 *
 * SO THE TWO NIGHTS BELOW ARE A PROPOSAL. They are not an announcement,
 * they are not a Round1 product, and every row in this file is badged
 ...
 * ---------------------------------------------------------------
 *
 * Round1 publishes no price for anything: not a party package, not a
 ...
 * instead.
 *
 * NO LANE COUNT EITHER. Round1 publishes none for any location, so
...
export const LEAGUES: League[] = [
  {
    ...
    gamesPerNight: 3,
    handicapNote:
      "Handicap scored, so a team of first timers can beat a team of regulars. Round1 publishes no handicap system, no team size and no format for anything, so all three below are this proposal's own and are labelled as such.",
  ...
  },
  {
    ...
    gamesPerNight: 3,
    handicapNote:
      "Handicap scored, on the same basis as the Tuesday night. Nothing about it is published by Round1, because Round1 publishes no league at all.",
...
team(
  {
    ...
    affiliationBasis: "Office and warehouse staff from one Cerritos site.",
  },
  [
