 ...
 * plan.
 *
 * WHAT IS SOURCED AND WHAT IS NOT. The facts about Round1 are sourced to
 * round1usa.com: the single published package, the absent price, the
 ...
 * date, nothing to tour, and no track record. Round1 has been trading in
...
const R1_PROFILE = "https://www.round1usa.com/profile";
const R1_LAKEWOOD = "https://www.round1usa.com/locations/lakewood-center-mall";
...
export const OBJECTIONS: Objection[] = [
  ...
  */
  ...
  },
  {
    ...
    voice:
      "Your head office is on Park Plaza Drive and your building is not. You are asking me to put a coach on the road to Lakewood for a staff night.",
    lanes: ALL_LANES,
    why: "Correct, and the register says so rather than talking around it. The US corporate headquarters is at 12900 Park Plaza Drive in Cerritos and the nearest store is at 401 Lakewood Ctr Mall in Lakewood. That is a real journey for a group that finishes work at six, and no amount of enthusiasm about the building shortens it.",
    answer:
