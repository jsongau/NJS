...
/**
 * What Round1 publishes about group business, and nothing else.
 *
 * EVERY FIELD IN THIS FILE WAS READ OFF ROUND1USA.COM AND CARRIES THE URL
 * IT WAS READ FROM. Where Round1 withholds a figure the field is null and
 ...
 * ROW. Round1 publishes exactly one named group offering, the All
 ...
 * one careless glance away from being read as Round1's. The competitive
...
/**
 * The booking terms Round1 actually publishes.
 *
...
export const STANDARD_TERMS = {
  ...
  changeNoticeDays: 3,
  /** Not published. Round1 states no minimum booking notice. */
  bookingNoticeDays: null,
  /** Not published. Round1 states no deposit percentage. */
  depositPercent: null,
  note: "Round1 publishes one booking term for the All Inclusive Party: changes require 3 or more days notice. No minimum booking notice and no deposit are published, on the party page or on the party room page.",
...
export const PACKAGES: EventPackage[] = [
  {
    ...
    /*
      ...
      published, for this package or for any Round1 location, so setting
...
/**
 * Packages Round1 publishes a price for.
 *
