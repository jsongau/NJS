 ...
 * that Round1 has an agreement with any licensor named here, or that
...
export const ANIME_GAP: LicenceGap = {
  ...
  notClaimed: [
    "No agreement between Round1 and any licensor named on this page.",
...
export const PARTNERS: Partner[] = [
  {
    ...
    source: NATURES_MARK_SOURCE,
    provenance: "public",
    note: "A connection Jay holds. There is no agreement between Round1 and Nature's Mark, and none between Round1 and any licensor on this list. Capability, not a deal.",
  },
  {
  ...
  },
  {
    ...
    region: "Cerritos and Lakewood, CA",
    provenance: "illustrative",
  },
  {
