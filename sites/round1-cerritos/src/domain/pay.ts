 ...
 * accelerator and no bonus mechanic appears on any Round1 page read for
 ...
 * posting, and a competitor's salary sitting under a Round1 heading is
...
export const BASE_BAND = {
  ...
  source:
    "Round1 publishes no salary, no band and no plan design for this role. These two numbers are this application's own scenario input, not a quotation, and they are deliberately round so that nobody mistakes them for one",
