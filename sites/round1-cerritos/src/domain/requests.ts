 ...
 *
 * Round1 publishes one way in for a group. The party page names the
 ...
 * in the same sentence as the number. It is not a claim about how Round1
 ...
 *
 * There is no tournament type in this file. Round1 publishes no
 ...
 * sets. Round1 publishes neither: the party page carries no readable
...
export const REQUEST_CHANNEL_META: Record<RequestChannel, RequestChannelMeta> = {
  "party-page": {
    ...
    source: "https://www.round1usa.com/book-a-party",
    provenance: "public",
  },
  phone: {
    ...
    source: "https://www.round1usa.com/activities-list/partyroom",
    provenance: "public",
  },
  "quote-page": {
 ...
 *
 * READ THE PROVENANCE BEFORE THE NUMBER. Round1 publishes no response
...
export const RESPONSE_COMMITMENT = {
  ...
  disclosure:
    "Round1 publishes no response time anywhere. This commitment is this desk's own, invented for the prototype, and it is not a claim about how Round1 operates.",
 ...
 * fork carried a real limit off a real intake form. Round1's party page
 ...
 *
 * READ THE OWNER OF THE ROW BEFORE READING A WORD OF IT. Round1
 ...
 * store's own page. Nothing in this type is a Round1 fact and nothing on
