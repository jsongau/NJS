 ...
 * contracts signed would read zero on almost every day of a first
 ...
 *
 * The territory is schools, employers and independents around Cerritos,
 * and none of them reads a cold email on a Sunday. A target that counted
