 ...
 *
 * This trade area has two hundred and eleven organisations in it and
 * one person working them. Sorting alphabetically, or by distance,
...
export interface DeskLine {
  ...
  /** Straight-line miles from 12900 Park Plaza Drive. */
  miles: number;
