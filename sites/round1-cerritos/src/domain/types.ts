 ...
 *
 * round1usa.com publishes one named group offering, the All Inclusive
...
export type Provenance =
   ...
   *
   * Round1 publishes the contents of its one party package and no price
 ...
 * check against round1usa.com is the fastest way to lose the room.
 */
export interface EventPackage {
   ...
   * ratio. Round1 publishes none, so this is absent on its one package
