 ...
 *
 * Nothing in here invents anything about Round1. These are names for
 ...
 * corporate family is unpriced because round1usa.com publishes no price
...
export const PACKAGE_FAMILY: Record<PackageFamily, FamilyToken> = {
  corporate: {
    ...
    note: "Unpriced on round1usa.com and gated behind a person at the venue. This family holds the one package Round1 publishes, and it is the reason the role exists.",
  },
  "youth-group": {
    label: "Youth group",
    glyph: "▥",
  ...
  fundraiser: {
    ...
    note: "A community door-opener before it is a sale, and the group brings its own crowd. Round1 publishes no fundraiser programme, so this family currently holds nothing, and the empty family is itself the finding.",
  },
};
