 ...
 * largest group that still fits. Round1 publishes NO BOWLING LANE COUNT
 ...
 * operator's building printed on a page about Round1. A reader who checked
 * it would find nothing on round1usa.com to check it against, and would
 * be right to stop trusting the addresses, the package contents and the
 * dates as well. A wrong lane count in front of a Round1 reader is the
 ...
 * Round1 employee could catch.
 */
const HOUSE_LANES: number | null = VENUE.bowlingLanesPublished;

/** The one sentence every absence on this page resolves to. */
const NO_LANE_COUNT =
  "Round1 publishes no bowling lane count for any location, including Lakewood Center, the nearest store to this office. There is no house total, so there is no share, no free lanes and no fullness to report. The number comes from the store, not from a page.";
 ...
 *
 * Round1 publishes no lane count for any location, so there is no
      ...
      */}
      {HOUSE_LANES === null ? (
        <p className={styles.markerNote}>
          ...
          <span>
            No ceiling is marked on this bar. Round1 publishes no bowling lane
 ...
 * and no both need the house lane count, and Round1 publishes none for
            ...
            */}
            ...
            {result?.fits === null ? (
              ...
              >
                ...
                published for any Round1 location, so that is the question to
...
export function CapacityPage() {
   ...
   * lanes an evening holds. Round1 publishes that for no location, so
      ...
      <div className={styles.inner}>
        <header className={styles.head}>
          ...
          {/* The title used to name a lane count. It cannot, because
              Round1 publishes none, and a heading is the last place to
        ...
        <section className={styles.terms} aria-labelledby="terms-h">
          ...
          <ol className={styles.termList}>
            ...
            <li className={styles.term}>
              ...
              <span className={styles.termNote}>
                Round1 publishes no lane count for any location, including
        ...
        <section className={styles.twoFigures} aria-labelledby="both-h">
          <div className={styles.bothBody}>
            ...
            */}
            <p className={styles.bothText}>
              ...
              takes, and Round1 publishes no lane count for any location.
            </p>
            <p className={styles.bothText}>
              <strong>
                {buyoutMax === null ? (
          ...
          <div className={styles.bothFigures}>
            ...
            <div className={styles.bigFig}>
              ...
              <span className={styles.bigLabel}>
                guests at a full site buyout, which Round1 does not publish
                either
              </span>
              <ProvenanceBadge
                provenance={
            ...
            <div className={styles.callout}>
              ...
              */}
              <p className={styles.calloutText}>
                ...
                answerable from any published page, because Round1 gives no
        ...
        <section className={styles.dates} aria-labelledby="dates-h">
          ...
          {/*
            ...
            the house total minus what is held. Round1 publishes no lane
          ...
          {live.length === 0 ? (
            ...
            <>
              ...
              {/*
                ...
                and Round1 publishes that for no location, so `evenings`
              ...
              {evenings.length === 0 ? (
                <p className={styles.empty}>
                  ...
                  <span>
                    ...
                    holds, and Round1 publishes no lane count for any location.
                ...
                <p className={styles.stressRead}>
                  ...
                  {HOUSE_LANES === null ? (
                    <>
                      ...
                      no lane count is published for any Round1 location.
                      <ProvenanceBadge provenance="withheld" compact />
                    </>
                  ) : (
                    <>
