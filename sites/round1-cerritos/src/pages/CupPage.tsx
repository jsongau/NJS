    ...
    return [
      {
        ...
        /* The field size used to be justified as lanes over a published
           house of twenty six. Round1 publishes no lane count anywhere,
      ...
      <div className={styles.inner}>
        ...
        <header className={styles.head}>
          ...
          <p className={styles.framing}>
            ...
            <span>
              A proposed programme, not an announcement. Round1 has not
        ...
        <section className={styles.section} aria-labelledby="cup-fixtures">
          ...
          <StatStrip label="The format, in figures derived from the field">
            ...
            {/*
              ...
              by. Round1 publishes no lane count for any location, so
            ...
            */}
            <Stat
              ...
              note="A cup night holds sixteen lanes. What share of the house that is cannot be given, because Round1 publishes no bowling lane count for any location, including Lakewood Center."
              provenance="withheld"
            />
            <Stat
        ...
        <section className={styles.section} aria-labelledby="cup-cadence">
          ...
          <p className={styles.sectionFoot}>
            ...
            counts themselves, because Round1 publishes no house lane count to
 ...
 * carry is the right one here: Round1 publishes no price and has
