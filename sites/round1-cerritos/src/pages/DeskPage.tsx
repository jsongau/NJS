 ...
 * This trade area has a hundred and nine organisations in it and one
 * person working them. Alphabetical, by distance, or by rating all
 * produce a list that looks organised and wastes the week. The
      ...
      {expanded ? (
        <div className={styles.breakdown} id={whyId}>
          ...
          <p className={styles.breakdownFoot}>
            ...
            Lanes at the midpoint headcount, at an illustrative planning
            ratio of one lane per twenty guests. Round1 publishes no lane
            ratio and no lane count, so this sizes the ask and never the
            building:{" "}
        ...
        */}
        ...
        <header className={styles.head}>
          ...
          {/*
            ...
            words: a count in the lede, "All eight lanes" on the first
            filter, and the same count again in the result line. A ninth
            lane landed and the board was researched again from a
            different address, and the prose stayed where it was, so the
            first sentence on
        ...
        */}
        ...
        <section className={styles.kpis} aria-labelledby="desk-strip-heading">
          ...
          <Kpi
            ...
            note="Real, inside roughly seven miles of 12900 Park Plaza Drive. Every one was read off a published page and geocoded with the US Census Bureau geocoder on 17 August 2026. No Places call was made, so no row carries a place id."
            provenance="public"
          />
          <Kpi
          ...
          <Kpi
            ...
            label="Never touched"
            note="What a trade area nobody has worked yet actually looks like on day one. Softening this would have been the dishonest move."
