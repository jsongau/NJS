 ...
 * straight-line distance from 12900 Park Plaza Drive because that is
 ...
 *
 * Nothing here invents a Round1 fact. The office address and the support
 ...
 * 12900 Park Plaza Drive, which is the one address in this application
...
export function FieldPage() {
  ...
  /* The run. Sorted by straight-line distance from Park Plaza Drive,
      ...
      <div className={styles.inner}>
        ...
        <section className={styles.kpis} aria-label="The period at a glance">
          ...
          <Kpi
            ...
            note={`This app holds itself to ${Math.round(OUTSIDE_SHARE_FLOOR * 100)}% or better. That bar is this app's own and Round1 publishes no such figure.`}
            provenance="modeled"
          />
        </section>
        ...
        <section className={styles.section} aria-labelledby="run-h">
          <div className={styles.sectionHead}>
            ...
            <p className={styles.sectionLede}>
              ...
              all, sorted by straight-line distance from Park Plaza Drive.
            </p>
          ...
          <div className={styles.split}>
            ...
            >
              ...
              <span>
                ...
                app's own and it is illustrative; Round1 publishes no such
            ...
            <div className={styles.formGrid}>
              ...
              <div className={styles.field}>
                ...
                <input
                  ...
                  placeholder="Los Cerritos Center corridor, employer lobbies, Friday lunch hour"
                />
                <span className={styles.fieldHint}>
