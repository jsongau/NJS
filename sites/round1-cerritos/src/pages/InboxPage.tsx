 ...
 * The application could already say where every organisation on the board
 * stood and what had gone out of the outbox. What it could
 ...
 * that can show every organisation on the board and the last thing said
 ...
 * which is most of the board and is not a thread.
 */
...
export function InboxPage() {
  ...
  return (
    <div className={styles.page}>
      ...
      {/*
        THE FILTER BAR. At a hundred odd records the common
