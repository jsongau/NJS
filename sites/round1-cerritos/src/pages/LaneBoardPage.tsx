 ...
 * what Round1 actually sells into them, and the single hardest thing
 * about reaching them at all. That last one is the field
 ...
 * calls, made in two different months, and confusing them is how a desk
 * spends October on discretionary buyers and discovers in June that every
 * grad night in the trade area went somewhere else.
 *
    ...
    >
      ...
      <div className={styles.stats}>
        <Stat
          ...
          provenance="public"
          title="Real organisations inside the trade area. Every one was read off a published page and geocoded with the US Census Bureau geocoder on 17 August 2026. No Places call was made, so no row carries a place id."
        />
        <Stat
          value={count(rollup.emailable)}
          label="publish an email"
          provenance="public"
          title="Read off the organisation's own page, with the URL it was read from on the row. No published address was read in this pass, so this count is zero and nothing here was guessed from a domain name."
        />
        <Stat
      ...
      */}
      <div className={styles.problem}>
        <p className={styles.problemLabel}>
          ...
          The hardest thing about this lane
        </p>
        <p className={styles.problemText}>{meta.laneProblem}</p>
      </div>

      <div className={styles.packages}>
        <h4 className={styles.packagesTitle}>
          What Round1 sells into it
        ...
        {/* The gated count is the finding, not a comment on it: those pages
            say to contact the venue. */}
        <p
          className={styles.gated}
          title="Round1's page for each gated package says to contact the venue."
        >
          {gated === 0 ? (
    ...
    <div className={styles.page}>
      <div className={styles.inner}>
        ...
        {[locked, chosen].map((group) => {
          ...
          /* The top of the summed range, in bowling lanes, at this app's own
             planning ratio of one lane per twenty guests. It is here rather
             than on each card because the interesting comparison is between
             the two classes. What share of a house that is cannot be said,
             because Round1 publishes no lane count for any location. */
        ...
        <p
          ...
          title="Every package name, guest minimum, day part and price on this page was read off round1usa.com on 17 August 2026 and carries the URL it came from on the packages screen."
        >
          Packages read off round1usa.com, 17 August 2026. A missing price is
          missing because Round1 does not publish one.
        </p>
      </div>
    </div>
  );
