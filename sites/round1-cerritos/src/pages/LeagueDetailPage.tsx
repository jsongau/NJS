 ...
 * page, because Round1 publishes no bowling lane count for any location
        ...
        <StatStrip label={`${league.name} at a glance`}>
          ...
          */}
          <Stat
            ...
            note="A league night holds its lanes and that figure is beside this one. What share of the house it is cannot be given, because Round1 publishes no bowling lane count for any location, including Lakewood Center."
            provenance="withheld"
          />
          <Stat
        ...
        <section className={shared.section} aria-labelledby="ld-slots">
          ...
          <div className={styles.positions}>
            ...
            <p className={styles.positionNote}>
              Round1 publishes no team size and no format for anything.
