 ...
 * ROUND1 PUBLISHES NO LEAGUE. Nothing here has bowled a frame. So there
 * are no standings on this page, because standings would be a season that
 * did not happen, rendered next to a board of real organisations and a
 * licence table that is scrupulous about what it does and does not
 ...
 *
 * ── AND THE PROGRAMME IS NOT ROUND1'S ─────────────────────────────
 * Round1 publishes no league of any kind, at any location. A competitor
 * does publish one, Open Lane Socials, at select locations and none of
 * them in California, and that programme is reproduced at the bottom of
 * this page as that competitor's published fact and nothing else. The
 * two leagues on this board are this application's own proposal and the
 * page says so above the fold, so a reader can see exactly where the
 * line between the three of them sits.
 *
 * ── LEAGUE MONEY IS NOT ON THIS PAGE ──────────────────────────────
 * Round1 publishes no league price anywhere and neither does any
      ...
      <div className={styles.inner}>
        <header className={styles.head}>
          ...
          <p className={styles.framing}>
            ...
            <span>
              A proposal, not an announcement. Round1 publishes no league
        ...
        <StatStrip label="Both leagues at a glance">
          <Stat
            ...
            note="Two nights, both taking registrations for a first season that has not been scheduled yet."
        ...
        <p className={styles.priceLine}>
          <WithheldFigure
            reason={
              <>
                Round1 publishes no league and therefore no league price.
                No dollar amount appears on any comparable competitor's
                leagues page either, Bowlero and Lucky Strike included. A
                season price here would be a number nobody could check.
              </>
            }
          />
        </p>
        ...
        {/* ===========================================================
            6. WHAT A COMPETITOR ACTUALLY PUBLISHES
            =========================================================== */}
        <section className={styles.section} aria-labelledby="lg-published">
          <SectionHead
            eyebrow="Six"
            id="lg-published"
            title="What a competitor publishes about leagues"
              ...
              <>
                ...
                <span>
                  ...
                  <a
                    ...
                    rel="noreferrer"
                  >
                    the competitor's published leagues page
                  </a>{" "}
                  on 11 August 2026.
                </span>
              </>
          ...
          <div className={styles.pubGrid}>
            <div className={styles.pubCard}>
              ...
              <p className={styles.pubScope}>
                <span aria-hidden="true">◆</span> {OPEN_LANE_SOCIALS.localNote}
              </p>
            </div>
          ...
          <p className={styles.sectionFoot}>
            Lane arithmetic is on <Link to="/calendar">capacity</Link>, and it
            stops at the lanes a group needs, because Round1 publishes no house
            lane count to hold them against. Every formula and source is on{" "}
  ...
  return (
    <article className={styles.card}>
      ...
      <dl className={styles.cardFacts}>
        ...
        {/*
          The sub-line was the night's share of the house. `laneSharePct`
          is null for every league, because Round1 publishes no bowling
          lane count for any location and a percentage needs something
          underneath it. The lanes a league holds is a real figure and it
          stays where it was.
        */}
        <div className={styles.cardFact}>
          ...
          <dd>
            ...
            <span className={styles.factSub}>
              Round1 publishes no lane count, so there is no share to give
            </span>
          </dd>
        </div>
        <div className={styles.cardFact}>
