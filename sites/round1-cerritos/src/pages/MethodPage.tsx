...
export function MethodPage() {
  ...
  */
  ...
  /*
    ...
    `houseLanes` is null, because Round1 publishes no bowling lane count
      ...
      <div className={styles.inner}>
        <header className={styles.head}>
          ...
          <p className={styles.subLede}>
            The published figures were read off round1usa.com and link back
          ...
          <div className={styles.prose}>
            ...
            >
              <div className={styles.tallies}>
                <Tally
                  ...
                  label="organisations"
                  provenance="public"
                  title="Every one inside the trade area around 12900 Park Plaza Drive, Cerritos, read off a published page and geocoded through the US Census Bureau one-line geocoder on 17 August 2026."
                />
                <Tally
              ...
              <div className={styles.callout}>
                ...
                <p className={styles.calloutText}>
                  ...
                  route, sorted by distance from Park Plaza Drive, and a
              ...
              <p className={styles.sources}>
                <Src
                  href={VENUE.source}
                  label="Round One Entertainment, Inc.'s corporate profile page on round1usa.com"
                >
                  The corporate profile page
                </Src>
                <Src
                  href={INBOUND_ROUTES.partyBookingUrl}
                  label="Round1's party booking page on round1usa.com"
                >
            ...
            >
              ...
              <p className={styles.p}>
                ...
                here specifically as not published by Round1:{" "}
            ...
            >
              ...
              <p className={styles.p}>
                ...
                figure could not be found. It means Round1 has one and
                deliberately does not print it.
              </p>

              <p className={styles.p}>
                Look at what Round1 puts on a page. The All Inclusive Party is
              ...
              <div className={styles.tallies}>
                <Tally
                  ...
                  provenance="public"
                  title="Priced on round1usa.com. These could be quoted in an email without a phone call, and there are none."
                />
                <Tally
                  value={String(gated)}
              ...
              <p className={styles.p}>
                Round1 has drawn a line through its own product range. Below
              ...
              <p className={styles.p}>
                ...
                fetch. What is true is both shorter and stronger. Round1
              ...
              <p className={styles.sources}>
                ...
                <Src
                  ...
                  label="Round1's party room activity page on round1usa.com"
                >
                  The party room page
                </Src>
                <Src
                  href={SOURCE_LINKS.nearestStore}
                  label="The Lakewood Center store page on round1usa.com"
                >
                  The nearest store
                </Src>
                <Src
                  href={STANDARD_TERMS.source}
                  label="The party booking page on round1usa.com, where the change notice is published"
                >
            ...
            >
              <div className={styles.tallies}>
                ...
                <Tally
                  ...
                  provenance="withheld"
                  title="Round1 publishes no bowling lane count for any location, including Lakewood Center, the nearest store to this office. There is no floor, no ceiling and no count."
                />
                <Tally
                  value={
              ...
              <p className={styles.p}>
                ...
                {bigGroupShare === null
                  ? "Round1 publishes no lane count for any location, so there is nothing to divide by."
                  : `It is ${bigGroupShare}% of the house.`}
              </p>

              <div className={styles.withheldDemo}>
                <WithheldFigure
                  reason={`What share of the house a ${bigGroupLanes} lane booking takes. Round1 publishes no bowling lane count for any location, including Lakewood Center, so the denominator does not exist.`}
                />
              </div>
              ...
              <div className={styles.callout}>
                ...
                <p className={styles.calloutText}>
                  ...
                  company's building in a different city, and a Round1 reader
                  who went looking for it would find nothing, because Round1
              ...
              <p className={styles.p}>
                ...
                absences are the same absence: Round1 sells the group business
              ...
              <p className={styles.sources}>
                <Src
                  href={SOURCE_LINKS.nearestStore}
                  label="The nearest Round1 store page, which carries an amenity list and no lane count"
                >
                  Where a lane count would be, if there were one
                </Src>
                <Src
                  href={SOURCE_LINKS.bookAParty}
                  label="The Round1 party booking page, which itemises a package and prices nothing"
                >
                  The party booking page
                </Src>
              </p>
            ...
            >
              <div className={styles.tallies}>
                <Tally
                  ...
                  title="Ordinary forward quarters. Round1 publishes no trading calendar of any kind, so there is nothing to count against and nothing was invented."
                />
                <Tally
                  value={String(OFFERS.length)}
                  label="offers on the table"
                  provenance="illustrative"
                  title={`${illustrativeOffers} invented and ${publicOffers} published. Every published one quotes something already on round1usa.com.`}
                />
                <Tally
              ...
              <p className={styles.p}>
                ...
                because Round1 publishes no trading calendar and inventing one
              ...
              <p className={styles.p}>
                ...
                off a price Round1 has never published. You cannot discount a
              ...
              <p className={styles.p}>
                ...
                invented quote what Round1 already publishes: the contents of
                ...
                round1usa.com in fifteen seconds.
              </p>
              ...
              <p className={styles.p}>
                ...
                <strong className="num">{gated}</strong> Round1 gates. That
              ...
              */}
              ...
              <p className={styles.p}>
                <strong>
                  Round1 publishes no response time anywhere on its site.
                </strong>{" "}
              ...
              <p className={styles.p}>
                ...
                nearest Round1 trades from 10am to midnight on weekdays and to
              ...
              <p className={styles.p}>
                ...
                they may not have been to, at a price Round1 does not publish.
              ...
              <ol className={styles.dayOne}>
                <li className={styles.dayOneItem}>
                  ...
                  <p className={styles.dayOneHow}>
                    ...
                    demand half, because Round1 publishes no lane count for any
                ...
                <li className={styles.dayOneItem}>
                  ...
                  <p className={styles.dayOneHow}>
                    ...
                    because Round1 publishes no bowling lane count for any
            ...
            <Section
              ...
              lead={
                <>
                  ...
                  No colour in it was sampled from Round1. Every one was
            ...
            <Section
              ...
              lead={
                <>
                  This is an independent work sample. It is not a Round1
                  product, it does not represent Round1, and it was built by one
            ...
            >
              <div className={styles.disclaimer}>
                <p className={styles.disclaimerP}>
                  R1 is an unaffiliated work sample by Nathan J. Song, built
                  for a New Business Development Promotion Planner application
                  at Round1. It is not affiliated with, endorsed by or
                  connected to Round One Entertainment, Inc. in any way.
                </p>
                <p className={styles.disclaimerP}>
                  No Round1 logo, wordmark, typeface or trade dress appears
                  anywhere in it. The colours here were chosen for the work they
                  do on a screen and none of them was sampled from Round1's
                  site. A hue is not a mark; a lockup is, and there is no lockup
                  here.
                </p>
                <p className={styles.disclaimerP}>
                  Every published figure in this application was read off
                  round1usa.com and carries the page it came from. All{" "}
