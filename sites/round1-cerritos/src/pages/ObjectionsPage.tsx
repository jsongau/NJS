...
import { PACKAGES, GATED_PACKAGES } from "@/data/packages";
 ...
 * by publishing a figure that is currently withheld, or by accepting
 * that a whole lane is unsellable as it stands. Nothing tells those two
 ...
 * a held date gives away optionality on the calendar, a same week
 * written quote gives away a slot in the manager's diary, and conceding
 * a competitor's published terms gives away an advantage that was never
 * there.
 *
 * ----- WHY ONE CARD IS TWICE THE SIZE OF THE OTHERS -------------------
 *
 * "Your website will not tell me what it costs" is not one objection
 * among several. It is true of every conversation in every lane, it is
 * Round1's own deliberate design rather than an accident of the website,
 * and the honest answer to it is the entire argument for filling this
 * role. Round1 names one group package, itemises it in full, and
 * publishes no price for it, no room capacity, no hourly rate and no
 * minimum spend. The page says to contact the venue. The price really
 * does come from a person.
 *
 ...
 * would have left it as the first of several identical cards, which is a
 * layout that has quietly decided they are all the same size of
 * problem.
 *
      ...
      <div className={styles.inner}>
        <header className={styles.head}>
          ...
          <p
            ...
            title="The facts underneath these rows are sourced: the unpriced party package, the published terms a competitor puts on its own page, the absence of a store at this address. The sentences in quotation marks were written for this work sample."
          >
          ...
          <section className={styles.feature} aria-labelledby="feature-h">
            <div className={styles.featureHead}>
              ...
              <h2 className={styles.h2} id="feature-h">
                The objection Round1 created on purpose
              </h2>
            ...
            {cardFor(
              ...
              <div className={styles.gate}>
                ...
                <p className={styles.gateText}>
                  No group package carries a published price. The page says to
                  contact the venue, so the number comes from a person, and
                  putting that person in front of a buyer is the whole of the
                  work.
                </p>
                ...
                <div className={styles.gateFigures}>
                  <div className={styles.gateFigure}>
                    <span className={styles.gateFigureLabel}>
                      Group price, any package
                    </span>
                    <WithheldFigure
                      reason={
                        <>
                          The page says to contact the venue, so the price
                          comes from a person. Nothing on round1usa.com
                          narrows it, not even a range, and no page carries a
                          published email address to ask on.
                        </>
                      }
                    />
                  </div>
                  ...
                  <div className={styles.gateFigure}>
                    <span className={styles.gateFigureLabel}>
                      Minimum food spend per guest
                    </span>
                    <WithheldFigure
                      reason="Pizza and soda are named as included and nothing is costed. No food floor, no per person minimum and no banquet rate appears on any published page."
                    />
                  </div>
                </div>
                ...
                <p className={styles.gateFoot}>
                  <Link to="/packages">
                    Every package, and what Round1 publishes for it
                  </Link>
                  .
                </p>
              </div>,
          ...
          <section className={styles.notable} aria-labelledby="notable-h">
            ...
            {cardFor(
              ...
              <div className={styles.gate} data-variant="notable">
                ...
                <p className={styles.gateText}>
                  Do not sell against their night. Bowling, karaoke, billiards
                  and ping pong is a different evening for the same group
                  rather than the same evening with a different sign on it,
                  and karaoke is the part the incumbent does not have.
                </p>
                <p className={styles.gateFoot}>
