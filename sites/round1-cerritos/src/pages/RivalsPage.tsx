 ...
 * a per head price in every cell, a green tick where Round1 is cheaper.
          ...
          */}
          <div className={styles.noPrice}>
            ...
            <p className={styles.noPriceBody}>
              ...
              per head price on a page. It is the same gate Round1 puts on its
