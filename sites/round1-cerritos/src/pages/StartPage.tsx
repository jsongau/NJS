 ...
 * destinations, a board of a hundred odd organisations, and no sentence
 * anywhere saying what they were looking at or why a corporate office in
 * Cerritos needs any of it. The work was doing the arguing and the work
 * is dense. Dense is correct for the eighth day and wrong for the first
 * ninety seconds.
 *
    ...
    <div className={styles.page} data-sec="none">
      <main className={styles.wrap}>
        <header className={styles.mast}>
          ...
          <h1 className={styles.title}>R1</h1>
          <p className={styles.standfirst}>
            A working territory and partner console for the trade area
            around {VENUE.name}'s US corporate headquarters in{" "}
            {VENUE.city}, built by one person as part of an application for
            the promotion planner job there.
          </p>
        </header>
        ...
        */}
        <p className={styles.flag}>
          This is not a Round1 product. It is not affiliated with,
          endorsed by, or connected to Round One Entertainment, Inc., and
          no part of it was built with access to their systems, their data
          or their people. Everything in it was assembled from published
        ...
        <section className={styles.block}>
          ...
          <p>
            The role is office based and it sources promotional product,
            negotiates with vendors and licensors, and puts anime and game
            properties in front of the audience that already turns up for
            an arcade and a bowling lane. All of that starts with the same
            question a map answers badly and a spreadsheet answers worse:
            who is actually within reach of this office, which of them
            could print, decorate, pack or licence something, which of them
            has an audience worth co-marketing to, and which one is worth
            the first visit.
          </p>
          <p>
            So this is not a CRM with sample data in it. It is a territory
            and partner console for the {VENUE.city} trade area, and it
            answers one question asked every morning, which is what to do
            next and why that and not something else.
          </p>
        </section>
        ...
        <section className={styles.block}>
          ...
          <p>
            ...
            there, then putting the street address through the US Census
            Bureau geocoder. Every row carries the page it was read off.
            Nothing was guessed from a domain name. Twenty four researched
            organisations are not on the board at all, because the
            geocoder could not place them or came back with a different
            street, and they are listed as removed rather than quietly
            dropped.
          </p>
          <p>
            Nothing about Round1's own trading is real here, because
            almost none of it is published. Every figure in the
            application carries one of six labels saying where it came
            from, from <strong>public</strong> at one end to{" "}
            <strong>illustrative</strong> and <strong>withheld</strong> at
            the other, and a figure Round1 has not published is drawn as
            withheld rather than filled in with a plausible number. There
            is no lane count on any screen, and no party price, because
            Round1 publishes neither.
          </p>
        ...
        <section className={styles.block}>
          ...
          <ul className={styles.list}>
            <li>
              Not a proposal. Nothing here recommends that Round1 do
