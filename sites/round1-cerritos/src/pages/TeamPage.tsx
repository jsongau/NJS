 ...
 * at render. Two of the three seats are open, which is what a territory
 * nobody has worked actually looks like, and a screen that showed three
      ...
      <div className={styles.inner}>
        <header className={styles.head}>
          ...
          <p className={styles.lede}>
            The posting asks for a manager who keeps supplier and licensor
            relationships strong while scouting new vendor opportunities,
            and who tracks how the product sells.{" "}
        ...
        <p className={styles.foot}>
          Both seat titles come from the published posting itself and
          nowhere else. Everything else about a seat, the start date, the
          signoff dates, the signing role and the lane split, is this
          application's own proposal, invented for this prototype and badged
          as such. It is not a claim about how Round1 staffs a team. The
          organisation
