 ...
 * only genuinely scarce resource a territory planner has, which is hours
 * outside the office.
 *
 ...
 * list of a hundred and nine organisations, a map and a panel was a
 * strip.
 ...
 * behind an icon.
 *
 * ── THE ANCHOR IS AN OFFICE AND THE MAP SAYS SO ──────────────────
 * The mark at 12900 Park Plaza Drive is Round One Entertainment, Inc.'s
 * US corporate headquarters. Nobody bowls there: it is where the role
 * reports and where every distance on this board is measured from, and
 * the nearest store is Lakewood Center, which sits inside the same trade
 * area. A reader who takes the anchor for a venue reads every other pin
 * as a customer instead of as an organisation nobody has spoken to.
 *
 * ── ONE FILTER, TWO SCREENS ───────────────────────────────────────
 * The lane chips in the left pane write to PipelineProvider, which is the
 * same state the desk reads. Filter to schools here and the desk is
 * filtered to schools when the reader gets back to it, because a filter
...
export function TradeAreaPage() {
  ...
  */
  ...
  return (
    <FullBleedRoute label="Maps, the Cerritos trade area board">
      <MapBoard
        nowMonth={NOW_MONTH}
        screenName="Maps"
            ...
            */}
            ...
            <div className={styles.ringsBody}>
              <p>
                ...
                published coordinates. The mark in the middle is a corporate
                office rather than a store, and nothing on this map is a
                customer of anybody's yet.
              </p>
              <p>
                ...
                than of the prospect, and hours outside the office are the
                only genuinely scarce resource this job has.
              </p>
              <p>
                ...
                Two organisations the same distance from the building can cost
                very different amounts of a morning. One sits on a road that
                runs straight back to Park Plaza Drive; the other is the same
