 ...
 *    improvise one.
 *
 * Nothing on this page invents a Round1 fact. The office block is the
...
> = {
  "go-see": {
    ...
    rule: "Ranked by no published email first, then by priority, then by how close they are to 12900 Park Plaza Drive. An organisation with a front desk and no inbox can be reached this way and no other.",
    wants: "door",
  },
  tabling: {
 ...
 * fewest lanes. Round1 publishes very little that can be offered without
          ...
          <article className={styles.sheet}>
            <div className={`${styles.masthead} avoid-break`}>
              ...
              {/*
                ...
                has created a problem no discount fixes. Round1 publishes no
              ...
              */}
              <p className={styles.noDate}>
                <span aria-hidden="true">▲</span>
                <span>
                  Round1 publishes no price for any group package, no room
